        ...
        <Link
            ...
            className={`inline-flex items-center border-b-2 px-3 pt-1 text-sm font-medium ${
                active
                    ...
                    : 'text-inactive focus:border-primary-700 dark:focus:bg-primary-300 border-transparent hover:border-gray-300 focus:bg-gray-50 dark:hover:border-gray-600 dark:focus:border-gray-600'
            } ${className}`}
        >
            {children}
        </Link>
