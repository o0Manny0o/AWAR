...
var pt = {
    ...
    qi = [...'0123456789ABCDEF'],
    Tc = (s) => qi[s & 15],
    Dc = (s) => qi[(s & 240) >> 4] + qi[s & 15],
    Us = (s) => (s & 240) >> 4 === (s & 15),
    Cc = (s) => Us(s.r) && Us(s.g) && Us(s.b) && Us(s.a)
function Pc(s) {
    var t = s.length,
        e
    return (
...
var Ac = (s, t) => (s < 255 ? t(s) : '')
function Ic(s) {
    var t = Cc(s) ? Tc : Dc
    return s ? '#' + t(s.r) + t(s.g) + t(s.b) + Ac(s.a, t) : void 0
}
var Ec =
...
var Ys
function $c(s) {
    Ys || ((Ys = Hc()), (Ys.transparent = [0, 0, 0, 0]))
...
function Zc(s, t, e) {
    let i = De(Nt(s.r)),
        ...
        o = De(Nt(s.b))
    return {
        r: qt(Zi(i + e * (De(Nt(t.r)) - i))),
        g: qt(Zi(n + e * (De(Nt(t.g)) - n))),
        b: qt(Zi(o + e * (De(Nt(t.b)) - o))),
        a: s.a + e * (t.a - s.a),
    }
}
function Zs(s, t, e) {
...
var hr = ['push', 'pop', 'shift', 'splice', 'unshift']
function ur(s, t) {
    if (s._chartjs) {
        ...
        let { iScale: r, vScale: a, _parsed: l } = s,
            c =
                s.dataset && s.dataset.options
                    ...
                    : null,
            h = r.axis,
            { min: u, max: d, minDefined: f, maxDefined: g } = r.getUserBounds()
        if (f) {
            if (
                ((n = Math.min(
                    Ct(l, h, u).lo,
...
var qs = (s) => s === 0 || s === 1,
    ...
    qo = (s, t, e) => Math.pow(2, -10 * s) * Math.sin(((s - t) * $) / e) + 1,
    Ce = {
        linear: (s) => s,
        easeInQuad: (s) => s * s,
        easeOutQuad: (s) => -s * (s - 2),
        ...
        easeInElastic: (s) => (qs(s) ? s : Zo(s, 0.075, 0.3)),
        easeOutElastic: (s) => (qs(s) ? s : qo(s, 0.075, 0.3)),
        easeInOutElastic(s) {
            return qs(s)
                ? s
                : s < 0.5
...
function mn(s) {
    return gn(s) ? s : new hs(s)
}
function Ki(s) {
    return gn(s) ? s : new hs(s).saturate(0.5).darken(0.1).hexString()
}
var ih = ['x', 'y', 'borderWidth', 'radius', 'tension'],
    nh = ['color', 'borderColor', 'backgroundColor']
function oh(s) {
    s.set('animation', {
        delay: void 0,
        duration: 1e3,
...
var tn = class {
        constructor(t, e) {
            ;(this.animation = void 0),
                ...
                (this.hover = {}),
                (this.hoverBackgroundColor = (i, n) => Ki(n.backgroundColor)),
                (this.hoverBorderColor = (i, n) => Ki(n.borderColor)),
                (this.hoverColor = (i, n) => Ki(n.color)),
                (this.indexAxis = 'x'),
                (this.interaction = {
                    mode: 'nearest',
                    intersect: !0,
...
var kh = (s, t) => (s === !0 ? t : typeof s == 'string' ? Wt(t, s) : void 0)
function vh(s, t, e, i, n) {
    for (let o of t) {
        let r = kh(e, o)
        if (r) {
            s.add(r)
            let a = _r(r._fallback, e, n)
...
function Dr(s) {
    return s === 'angle'
        ? { between: Fe, compare: sh, normalize: st }
        : { between: It, compare: (t, e) => t - e, normalize: (t) => t }
}
function Ko({ start: s, end: t, count: e, loop: i, style: n }) {
    return {
        start: s % e,
        end: t % e,
        loop: i && (t - s + 1) % e === 0,
...
function Tn(s, t, e) {
    ...
    let { property: i, start: n, end: o } = e,
        r = t.length,
        { compare: a, between: l, normalize: c } = Dr(i),
    ...
    return (
        p !== null &&
            g.push(Ko({ start: p, end: u, loop: d, count: r, style: f })),
        g
    )
}
function Dn(s, t) {
...
var In = (s) => s === 'reset' || s === 'none',
    Fr = (s, t) => (t ? s : Object.assign({}, s)),
    iu = (s, t, e) =>
    ...
    ut = class {
        ...
        linkScales() {
            let t = this.chart,
                ...
                o = (e.xAxisID = P(i.xAxisID, An(t, 'x'))),
                r = (e.yAxisID = P(i.yAxisID, An(t, 'y'))),
                a = (e.rAxisID = P(i.rAxisID, An(t, 'r'))),
                l = e.indexAxis,
        ...
        _destroy() {
            let t = this._cachedMeta
            this._data && ln(this._data, this), t._stacked && ys(t)
        }
        _dataCheck() {
        ...
        applyStack(t, e, i) {
            let n = this.chart,
                o = this._cachedMeta,
                r = e[t.axis],
                a = { keys: Ca(n, !0), values: e._stacks[t.axis]._visualValues }
            return Ir(a, r, o.index, { mode: i })
        }
        updateRangeFromParsed(t, e, i, n) {
            let o = i[e.axis],
                r = o === null ? NaN : o,
                a = n && i._stacks[e.axis]
            n && a && ((n.values = a), (r = Ir(n, o, this._cachedMeta.index))),
        ...
        _resolveElementOptions(t, e = 'default', i) {
            ...
            return (
                m.$shared &&
                    ((m.$shared = l), (o[r] = Object.freeze(Fr(m, l)))),
                m
            )
        }
        ...
        includeOptions(t, e) {
            return !e || In(t) || this.chart._animationsDisabled
        }
        ...
        updateSharedOptions(t, e, i) {
            t && !In(e) && this._resolveAnimations(void 0, e).update(t, i)
        }
        _setStyle(t, e, i, n) {
            t.active = n
...
function cu(s, t, e) {
    return s !== 0 ? St(s) : (t.isHorizontal() ? 1 : -1) * (t.min >= e ? 1 : -1)
}
function hu(s) {
    let t, e, i, n, o
    return (
...
function uu(s, t, e, i) {
    ...
    let { start: r, end: a, reverse: l, top: c, bottom: h } = hu(s)
    n === 'middle' &&
        e &&
...
var We = class extends ut {
    ...
    updateElements(t, e, i, n) {
        ...
        for (let f = e; f < e + i; f++) {
            ...
            uu(y, _, b, r), fu(y, _, h.ratio), this.updateElement(t[f], f, y, n)
        }
    }
    _getStacks(t, e) {
...
var Be = class extends ut {
    ...
    parseArrayData(t, e, i, n) {
        ...
        for (let r = 0; r < o.length; r++) {
            let a = e[i + r]
            o[r]._custom = P(a[2], this.resolveDataElementOptions(r + i).radius)
        }
        return o
    }
    parseObjectData(t, e, i, n) {
...
var jt = class extends ut {
    ...
    update(t) {
        let e = this.chart,
            ...
            l = Math.min(sr(this.options.cutout, a), 1),
        ...
        for (g = e; g < e + i; g++) {
            let p = t[g],
                ...
                _ = r.getDataVisibility(g)
                    ...
                    : 0
            ;(f = y),
                o && (l.animateScale && (_ = 0), l.animateRotate && (b = y = d))
            let w = {
                x: h,
                y: u,
                innerRadius: 0,
...
var _u = {
        ...
        modes: {
            index(s, t, e, i) {
                let n = ee(t, s),
                    ...
                    a = e.intersect ? Ln(s, n, o, i, r) : Fn(s, n, o, !1, i, r),
                    l = []
                return a.length
    ...
    Aa = ['left', 'top', 'right', 'bottom']
function xs(s, t) {
    return s.filter((e) => e.pos === t)
}
function Wr(s, t) {
    return s.filter((e) => Aa.indexOf(e.pos) === -1 && e.box.axis === t)
}
function _s(s, t) {
    return s.sort((e, i) => {
        let n = t ? i : e,
...
function Mu(s, t, e, i) {
    ...
    o.getPadding && Ia(r, o.getPadding())
    let a = Math.max(0, t.outerWidth - Br(r, s, 'left', 'right')),
        l = Math.max(0, t.outerHeight - Br(r, s, 'top', 'bottom')),
        c = a !== s.w,
        h = l !== s.h
    return (
        (s.w = a),
...
function Fu(s, t) {
    As.size || window.addEventListener('resize', La), As.set(s, t)
}
function Ru(s) {
    As.delete(s), As.size || window.removeEventListener('resize', La)
}
function Nu(s, t, e) {
    let i = s.canvas,
        n = i && hi(i)
...
var Un = class extends wi {
    ...
    addEventListener(t, e, i) {
        ...
        let n = t.$proxies || (t.$proxies = {}),
            r = { attach: Eu, detach: Lu, resize: Nu }[e] || zu
        n[e] = r(t, e, i)
    }
    removeEventListener(t, e) {
        let i = t.$proxies || (t.$proxies = {}),
            n = i[e]
        if (!n) return
        ;(({ attach: Rn, detach: Rn, resize: Rn })[e] || Au)(t, e, n),
            (i[e] = void 0)
    }
    getDevicePixelRatio() {
...
var Yu = (s) => (s === 'left' ? 'right' : s === 'right' ? 'left' : s),
    Ur = (s, t, e) => (t === 'top' || t === 'left' ? s[t] + e : s[t] - e),
    Yr = (s, t) => Math.min(t || s, s)
function Zr(s, t) {
    let e = [],
        i = s.length / t,
        n = s.length,
...
var we = class s extends dt {
        ...
        calculateLabelRotation() {
            let t = this.options,
                e = t.ticks,
                i = Yr(this.ticks.length, t.ticks.maxTicksLimit),
                n = e.minRotation || 0,
                o = e.maxRotation,
                r = n,
                a,
...
function Gn(s, ...t) {
    ...
    for (let e of t) {
        let i =
            e.axis || ld(e.position) || (s.length > 1 && Gr(s[0].toLowerCase()))
        if (i) return i
    }
    throw new Error(
...
function hd(s, t) {
    ...
    return (
        Object.keys(i).forEach((r) => {
            ...
            let l = Gn(r, a, cd(r, s), j.scales[a.type]),
                c = ad(l, n),
                h = e.scales || {}
...
function gi(s, t) {
    let e = Jr.get(s)
    return e || ((e = t()), Jr.set(s, e), Na.add(e)), e
}
var ks = (s, t, e) => {
        let i = Wt(t, e)
        i !== void 0 && s.add(i)
    ...
    Xn = class {
        ...
        resolveNamedOptions(t, e, i, n = ['']) {
            let o = { $shared: !0 },
                { resolver: r, subPrefixes: a } = Kr(this._resolverCache, t, n),
                l = r
            if (fd(r, e)) {
        ...
        createResolver(t, e, i = [''], n) {
            let { resolver: o } = Kr(this._resolverCache, t, i)
...
var dd = (s) => E(s) && Object.getOwnPropertyNames(s).some((t) => zt(s[t]))
function fd(s, t) {
    let { isScriptable: e, isIndexable: i } = xn(s)
    for (let n of t) {
        let o = e(n),
            r = i(n),
            a = (r || o) && s[n]
...
var be = class extends dt {
    ...
    inRange(e, i, n) {
        let o = this.getProps(['x', 'y'], n),
            { angle: r, distance: a } = an(o, { x: e, y: i }),
            {
                startAngle: l,
                endAngle: c,
                innerRadius: h,
...
function Td(s, t, e, i) {
    let { points: n, options: o } = t,
        { count: r, start: a, loop: l, ilen: c } = Wa(n, e, i),
        h = Od(o),
    ...
    for (f = 0; f <= c; ++f)
        (g = n[(a + (d ? c - f : f)) % r]),
            !g.skip &&
                ...
                (m = g))
    return l && ((g = n[(a + (d ? c : 0)) % r]), h(s, m, g, d, o.stepped)), !!l
}
function Dd(s, t, e, i) {
    let n = t.points,
        { count: o, start: r, ilen: a } = Wa(n, e, i),
...
var Ft = class extends dt {
    ...
    interpolate(t, e) {
        let i = this.options,
            n = t[e],
            o = this.points,
            r = Dn(this, { property: e, start: n, end: n })
        if (!r.length) return
        let a = [],
            l = Cd(i),
            c,
...
var Vd = Object.freeze({
    ...
    oa = Kn.map((s) => s.replace('rgb(', 'rgba(').replace(')', ', 0.5)'))
function Ha(s) {
    return Kn[s % Kn.length]
}
function $a(s) {
...
function Jd(s, t, e) {
    ...
    for (let a of i) {
        ...
        let u = Dn(t, h)
        for (let d of u) {
            let f = Qn(e, o[d.start], o[d.end], d.loop),
                g = Tn(a, n, f)
            for (let m of g)
                r.push({
                    source: m,
...
function lf(s, t, e) {
    ...
    for (let n = 0; n < e.length; n++) {
        let o = e[n],
            { first: r, last: a, point: l } = cf(o, t, 'x')
        if (!(!l || (r && a))) {
            if (r) i.unshift(l)
    ...
    Mi = class extends dt {
        ...
        fit() {
            ...
            let i = t.labels,
                ...
                { boxWidth: a, itemHeight: l } = fa(i, o),
                c,
                h
            ;(e.font = n.string),
                this.isHorizontal()
        ...
        _fitCols(t, e, i, n) {
            ...
            return (
                this.legendItems.forEach((p, b) => {
                    let { itemWidth: y, itemHeight: _ } = xf(i, e, o, p, n)
                    b > 0 &&
                        f + _ + 2 * a > h &&
                        ((u += d + a),
...
var Ps = class extends dt {
    ...
    update(t, e) {
        ...
        if (!n.length) this.opacity !== 0 && (o = { opacity: 0 })
            ...
            let l = (this._size = ga(this, i)),
                c = Object.assign({}, a, l),
                h = ma(this.chart, i, c),
                u = pa(i, c, h, this.chart)
    ...
    _updateAnimationTarget(t) {
        let e = this.chart,
            ...
            o = i && i.y
        if (n || o) {
            let r = Ms[t.position].call(this, this._active, this._eventPosition)
            if (!r) return
            let a = (this._size = ga(this, t)),
...
function Vf(s, t) {
    ...
    return (
        y && d && M !== a
            ? e.length && Le(e[e.length - 1].value, a, _a(a, w, s))
...
function $f(s) {
    ...
    for (let l = 0; l < o; l++) {
        ...
        let f = st(s.getIndexAngle(l) + a),
            g = Math.round(si(f)),
            m = va(g, h.x, d.w, 0, 180),
            p = va(g, h.y, d.h, 90, 270)
        jf(e, t, f, m, p)
    }
...
function Zf(s, t, e) {
    let i = [],
        ...
        l = { extra: to(o) / 2, additionalAngle: r ? F / n : 0 },
        c
    for (let h = 0; h < n; h++) {
...
var ye = class extends qe {
    ...
    setDimensions() {
        let t = (this._padding = nt(to(this.options) / 2)),
    ...
    drawGrid() {
        let t = this.ctx,
            ...
            c
        if (
            (e.pointLabels.display && Kf(this, r),
            n.display &&
...
var _e = class extends we {
    ...
    _generate() {
        let t = this._adapter,
            ...
            n = this.options,
            o = n.time,
            r = o.unit || Oa(o.minUnit, e, i, this._getLabelCapacity(e)),
...
var Yt = class extends Error {},
    ...
    Ol = { year: O, month: Dt, day: O },
    og = { year: O, month: Dt, day: O, weekday: Dt },
    Tl = { year: O, month: mt, day: O },
    Dl = { year: O, month: mt, day: O, weekday: mt },
    Cl = { hour: O, minute: O },
    Pl = { hour: O, minute: O, second: O },
    Al = { hour: O, minute: O, second: O, timeZoneName: Dt },
    Il = { hour: O, minute: O, second: O, timeZoneName: mt },
    El = { hour: O, minute: O, hourCycle: 'h23' },
    Ll = { hour: O, minute: O, second: O, hourCycle: 'h23' },
    Fl = { hour: O, minute: O, second: O, hourCycle: 'h23', timeZoneName: Dt },
    Rl = { hour: O, minute: O, second: O, hourCycle: 'h23', timeZoneName: mt },
    Nl = { year: O, month: O, day: O, hour: O, minute: O },
    zl = { year: O, month: O, day: O, hour: O, minute: O, second: O },
    Vl = { year: O, month: Dt, day: O, hour: O, minute: O },
    Wl = { year: O, month: Dt, day: O, hour: O, minute: O, second: O },
    rg = { year: O, month: Dt, day: O, weekday: Dt, hour: O, minute: O },
    Bl = { year: O, month: mt, day: O, hour: O, minute: O, timeZoneName: Dt },
    Hl = {
        year: O,
        month: mt,
        day: O,
...
var io = new Map(),
    ae = class s extends Me {
        ...
        offset(t) {
            ...
            let i = ag(this.name),
                [n, o, r, a, l, c, h] = i.formatToParts ? hg(i, e) : cg(i, e)
            a === 'BC' && (n = -Math.abs(n) + 1)
            let d = $i({
                    year: n,
                    month: o,
...
function bo(s, t = {}) {
    let e = JSON.stringify([s, t]),
        i = po.get(e)
    return (
        i === void 0 && ((i = new Intl.DateTimeFormat(s, t)), po.set(e, i)), i
    )
}
var yo = new Map()
function dg(s, t = {}) {
    let e = JSON.stringify([s, t]),
        i = yo.get(e)
    return i === void 0 && ((i = new Intl.NumberFormat(s, t)), yo.set(e, i)), i
}
var xo = new Map()
function fg(s, t = {}) {
    let { base: e, ...i } = t,
...
var ko = class {
        ...
        format(t) {
            if (this.inf) {
                ...
                let e = this.floor ? Math.floor(t) : Lo(t, 3)
    ...
    Yl = { firstDay: 1, minimalDays: 4, weekend: [6, 7] },
    B = class s {
        static fromOpts(t) {
            return s.create(
                t.locale,
...
var Ka = () => Date.now(),
    ...
    Y = class {
        ...
        static resetCaches() {
            B.resetCache(), ae.resetCache(), R.resetCache(), vg()
        }
    },
    gt = class {
        constructor(t, e) {
    ...
    Zl = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
...
var oc = [
    ...
    rc = ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
    Eg = ['M', 'T', 'W', 'T', 'F', 'S', 'S']
function ac(s) {
    switch (s) {
        case 'narrow':
...
var dc = /(?:([Zz])|([+-]\d\d)(?::?(\d\d))?)/,
    $g = `(?:${dc.source}?(?:\\[(${hc.source})\\])?)?`,
    Fo = /(\d\d)(?::?(\d\d)(?::?(\d\d)(?:[.,](\d{1,30}))?)?)?/,
    fc = RegExp(`${Fo.source}${$g}`),
    Ro = RegExp(`(?:[Tt]${fc.source})?`),
    jg = /([+-]\d{6}|\d{4})(?:-?(\d\d)(?:-?(\d\d))?)?/,
    Ug = /(\d{4})-?W(\d\d)(?:-?(\d))?/,
    Yg = /(\d{4})-?(\d{3})/,
    Zg = uc('weekYear', 'weekNumber', 'weekDay'),
    qg = uc('year', 'ordinal'),
    Gg = /(\d{4})-(\d\d)-(\d\d)/,
    gc = RegExp(`${Fo.source} ?(?:${dc.source}|(${hc.source}))?`),
    Xg = RegExp(`(?: ${gc.source})?`)
function ts(s, t, e) {
    let i = s[t]
    return D(i) ? e : ie(i)
...
var cm = is(jg, Ro),
    ...
    mm = ns(rs, Hs, $s)
function pm(s) {
    return os(s, [cm, mc], [hm, fm], [um, gm], [dm, mm])
}
function bm(s) {
    return os(nm(s), [sm, im])
}
function ym(s) {
    return os(s, [om, dl], [rm, dl], [am, lm])
}
function xm(s) {
    return os(s, [Qg, tm])
}
...
var km = is(Gg, Xg),
    ...
    Sm = ns(rs, Hs, $s)
function Mm(s) {
    return os(s, [km, mc], [vm, Sm])
}
var fl = 'Invalid Duration',
    pc = {
        weeks: {
            days: 7,
            hours: 168,
...
var tt = class s {
        ...
        rescale() {
            if (!this.isValid) return this
            let t = ml(this.normalize().shiftToAll().toObject())
...
function kc(s, t) {
    if (!s) return null
    let i = ft.create(t, s).dtFormatter(Hm()),
        n = i.formatToParts(),
        o = i.resolvedOptions()
    return n.map((r) => zm(r, s, o))
}
var ao = 'Invalid DateTime',
    xl = 864e13
function Ns(s) {
...
var Sc = { month: 1, day: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
    Um = {
        weekNumber: 1,
        weekday: 1,
        hour: 0,
...
function Gm(s) {
    ...
    let t = s.name,
        e = Co.get(t)
    return e === void 0 && ((e = s.offset(zs)), Co.set(t, e)), e
}
function vl(s, t) {
    ...
    if (D(s.year)) n = Y.now()
        ...
        for (let l of Ei) D(s[l]) && (s[l] = Sc[l])
        let r = Jl(s) || Kl(s)
    ...
    R = class s {
        ...
        static fromObject(t, e = {}) {
            ...
            let n = B.fromObject(e),
                o = Wi(t, kl),
                { minDaysInFirstWeek: r, startOfWeek: a } = ll(o, n),
                l = Y.now(),
        ...
        set(t) {
            if (!this.isValid) return this
            let e = Wi(t, kl),
                { minDaysInFirstWeek: i, startOfWeek: n } = ll(e, this.loc),
