;(() => {
            ...
            return (
                e === void 0 && (e = {}),
                {
                    ...
                    async fn(t) {
                        ...
                        await a({ ...t, availableWidth: Y, availableHeight: N })
            ...
            if (
                ...
                if (!Y || (vs(t, E, this) && !Y.animated)) {
                    ...
                    if (
                        ...
                        return $(), r.insertBefore(k, ne), (Ve = r), N(), A(!0)
    ...
    var xs = Object.create,
        ...
        _s = Bo((e) => {
            ...
            function y(u) {
                return (
                    (i(u) ? u.ownerDocument : u.document) || window.document
                ).documentElement
            }
            function m(u) {
            ...
            function A(u, s) {
                ...
                s === void 0 && (s = [])
                var T = $(u),
                    P = T === ((b = u.ownerDocument) == null ? void 0 : b.body),
                    F = r(T),
                    U = P
            ...
            function wn(u, s, b) {
                var T = s === 'clippingParents' ? yn(u) : [].concat(s),
                    P = [].concat(T, [b]),
                    F = P[0],
                    U = P.reduce(
                        function (H, G) {
                ...
                if (_e) {
                    if (F || H) {
                        var Ue = ce === 'y' ? V : Q,
                            ...
                            Zt = Re === h ? -Le[et] : -ke[et],
                            Sn = s.elements.arrow,
                            Wn = Ce && Sn ? _(Sn) : { width: 0, height: 0 },
            ...
            function cn(g, w) {
                ...
                function P() {
                    if (!(Gt || !x.props.aria.expanded)) {
                        var D = I(x.props.triggerTarget || g)
                ...
                function He(D) {
                    var K =
                        Pe(D) || (x.props.trigger.indexOf('click') >= 0 && B)
                    if (!K) {
                ...
                function Le() {
                    var D = x.props.appendTo,
                        K,
                        te = lt()
                    ;(x.props.interactive && D === Ze.appendTo) ||
                    D === 'parent'
                        ? (K = te.parentNode)
                        : (K = O(D, [te])),
