...
me.prototype = {
    ...
    prepend: function (t) {
        return (
            (t = me.from(t)),
            t.size ? new me(t.content.concat(this.subtract(t).content)) : this
        )
    },
    append: function (t) {
        return (
            (t = me.from(t)),
            t.size ? new me(this.subtract(t).content.concat(t.content)) : this
        )
    },
    subtract: function (t) {
        var e = this
...
function ya(t, e, n) {
    for (let r = 0; ; r++) {
        ...
        if (o.content.size || i.content.size) {
            let s = ya(o.content, i.content, n + 1)
            if (s != null) return s
        }
        n += o.nodeSize
    }
...
function ba(t, e, n, r) {
    for (let o = t.childCount, i = e.childCount; ; ) {
        ...
        if (s.content.size || l.content.size) {
            let c = ba(s.content, l.content, n - 1, r - 1)
            if (c) return c
        }
        ;(n -= a), (r -= a)
    }
...
function Mr(t, e) {
    ...
    if (n) {
        ...
        for (let r in t) if (!(r in e) || !Mr(t[r], e[r])) return !1
...
var zt = class extends Error {},
    E = class t {
        ...
        insertAt(e, n) {
            let r = xa(this.content, e + this.openStart, n)
        ...
        static fromJSON(e, n) {
            ...
            return new t(S.fromJSON(e, n.content), r, o)
        }
...
function xa(t, e, n, r) {
    ...
    let l = xa(s.content, e - i - 1, n, s)
    return l && t.replaceChild(o, s.copy(l))
}
function rp(t, e, n) {
    if (n.openStart > t.depth)
        throw new zt('Inserted content deeper than insertion position')
    if (t.depth - n.openStart != e.depth - n.openEnd)
        throw new zt('Inconsistent open depths')
    return ka(t, e, n, 0)
}
function ka(t, e, n, r) {
    let o = t.index(r),
    ...
    if (o == e.index(r) && r < t.depth - n.openStart) {
        ...
        if (!n.openStart && !n.openEnd && t.depth == r && e.depth == r) {
            ...
            let { start: s, end: l } = op(n, t)
            return Bt(i, Ca(t, s, l, e, r))
        }
    else return Bt(i, Tr(t, e, r))
}
function Sa(t, e) {
    if (!e.type.compatibleContent(t.type))
        throw new zt('Cannot join ' + e.type.name + ' onto ' + t.type.name)
}
function Ti(t, e, n) {
    let r = t.node(n)
...
function Ca(t, e, n, r, o) {
    let i = t.depth > o && Ti(t, e, o + 1),
        s = r.depth > o && Ti(n, r, o + 1),
        l = []
    return (
        Dn(null, t, o, l),
        i && s && e.index(o) == n.index(o)
            ? (Sa(i, s), Lt(Bt(i, Ca(t, e, n, r, o + 1)), l))
            : (i && Lt(Bt(i, Tr(t, e, o + 1)), l),
              Dn(e, n, o, l),
              s && Lt(Bt(s, Tr(n, r, o + 1)), l)),
        Dn(r, null, o, l),
        new S(l)
    )
}
function Tr(t, e, n) {
    let r = []
    if ((Dn(null, t, n, r), t.depth > n)) {
        let o = Ti(t, e, n + 1)
        Lt(Bt(o, Tr(t, e, n + 1)), r)
    }
    return Dn(e, null, n, r), new S(r)
}
function op(t, e) {
    let n = e.depth - t.openStart,
        o = e.node(n).copy(t.content)
    for (let i = n - 1; i >= 0; i--) o = e.node(i).copy(S.from(o))
    return {
...
var Ar = class t {
    ...
    ae = class t {
        ...
        hasMarkup(e, n, r) {
            return (
                this.type == e &&
                Mr(this.attrs, n || e.defaultAttrs || sp) &&
        ...
        replace(e, n, r) {
            return rp(this.resolve(e), this.resolve(n), r)
        }
        nodeAt(e) {
            for (let n = this; ; ) {
...
function hp(t) {
    ...
    function n(r) {
        ...
        let i = (e[r.join(',')] = new $t(r.indexOf(t.length - 1) > -1))
...
function Oa(t, e) {
    let n = Object.create(null)
    if (e) for (let r in e) n[r] = new Oi(t, r, e[r])
    return n
}
var Er = class t {
    constructor(e, n, r) {
    ...
    create(e = null, n, r) {
        ...
        return new ae(this, this.computeAttrs(e), S.from(n), q.setFrom(r))
    }
    createChecked(e = null, n, r) {
        return (
            (n = S.from(n)),
            this.checkContent(n),
            new ae(this, this.computeAttrs(e), n, q.setFrom(r))
        )
    }
    createAndFill(e = null, n, r) {
        ...
        return i ? new ae(this, e, n.append(i), q.setFrom(r)) : null
    }
    validContent(e) {
    ...
    an = class {
        constructor(e) {
            ...
            ;(n.nodes = Ci.from(e.nodes)),
                ...
                (this.marks = Pn.compile(this.spec.marks, this))
            let r = Object.create(null)
            ...
            ;(this.nodeFromJSON = (o) => ae.fromJSON(this, o)),
...
var ln = class {
        constructor(e, n, r, o, i, s) {
            ;(this.type = e),
                ...
                (this.match = i || (s & In ? null : e.contentMatch))
        }
        findWrapping(e) {
            if (!this.match) {
                if (!this.type) return []
        ...
        finish(e) {
            ...
            return (
                !e &&
                    this.match &&
                    (n = n.append(this.match.fillBefore(S.empty, !0))),
    ...
    Nr = class {
        constructor(e, n, r) {
            ...
            let o = n.topNode,
                i,
                s = fa(null, n.preserveWhitespace, 0) | (r ? In : 0)
            o
                ? (i = new ln(
                      o.type,
                      o.attrs,
        ...
        addTextNode(e, n) {
            let r = e.nodeValue,
                ...
                i =
                    o.options & Ri
                        ? 'full'
                        : this.localPreserveWS || (o.options & Ln) > 0,
...
`),
            ...
            if (o) {
                ...
                for (let l of o.concat(e.marks))
                    (i.type
                        ...
                        : pa(l.type, e.type)) && (s = l.addToSet(s))
        ...
        enterInner(e, n, r, o = !1, i) {
            ...
            s.options & In && s.content.length == 0 && (l |= In)
            let a = q.none
            return (
                (r = r.filter((c) =>
...
function kp(t) {
    let e = ga.get(t)
    return e === void 0 && ga.set(t, (e = Sp(t))), e
}
function Sp(t) {
    let e = null
    function n(r) {
...
function vr(t, e, n, r) {
    ...
    for (let u = d; u < e.length; u++) {
        ...
        if (f === 0) {
            ...
            let { dom: h, contentDOM: p } = vr(t, f, n, r)
            ...
            for (let l = 0; l < this.ranges.length; l += 3) {
                ...
                if (e <= u) {
                    let f = c ? (e == a ? -1 : e == u ? 1 : n) : n,
                        h = a + o + (f < 0 ? 0 : d)
                    if (r) return h
                    let p = e == (n < 0 ? a : u) ? null : Cp(l / 3, e - a),
                        m = e == a ? Ha : e == u ? za : Or
                    return (
                        (n < 0 ? e != a : e != u) && (m |= $a), new Hn(h, m, p)
                    )
                }
                o += d - c
            }
            return r ? e + o : new Hn(e + o, 0, null)
        }
        touches(e, n) {
            let r = 0,
                o = Ia(n),
    ...
    ue = class t {
        ...
        static fromReplace(e, n, r, o) {
            try {
                ...
                if (i instanceof zt) return t.fail(i.message)
                throw i
            }
        }
    }
function zi(t, e, n) {
    ...
    for (let o = 0; o < t.childCount; o++) {
        let i = t.child(o)
        i.content.size && (i = i.copy(zi(i.content, e, i))),
            i.isInline && (i = e(i, n, o)),
            r.push(i)
    }
    return S.fromArray(r)
}
var Fn = class t extends ce {
    constructor(e, n, r) {
...
ce.jsonID('addMark', Fn)
var lt = class t extends ce {
    constructor(e, n, r) {
        super(), (this.from = e), (this.to = n), (this.mark = r)
    }
    apply(e) {
    ...
    invert() {
        return new Fn(this.from, this.to, this.mark)
    }
    map(e) {
        let n = e.mapResult(this.from, 1),
            r = e.mapResult(this.to, -1)
...
ce.jsonID('removeMark', lt)
var Vn = class t extends ce {
    constructor(e, n) {
...
ce.jsonID('addNodeMark', Vn)
var cn = class t extends ce {
    constructor(e, n) {
        super(), (this.pos = e), (this.mark = n)
    }
    apply(e) {
...
ce.jsonID('removeNodeMark', cn)
var ge = class t extends ce {
...
ce.jsonID('replace', ge)
var ie = class t extends ce {
...
function Mp(t, e, n, r) {
    ...
    t.doc.nodesBetween(e, n, (a, c, d) => {
        ...
        if (!r.isInSet(u) && d.type.allowsMarkType(r.type)) {
            ...
            l && l.to == f ? (l.to = h) : i.push((l = new Fn(f, h, r)))
        }
    }),
    ...
    t.doc.nodesBetween(e, n, (s, l) => {
        ...
        if (a && a.length) {
            ...
            for (let d = 0; d < a.length; d++) {
                ...
                f
                    ? ((f.to = c), (f.step = i))
                    : o.push({ style: u, from: Math.max(l, e), to: c, step: i })
            }
        }
    }),
...
function Hi(t, e, n, r = n.contentMatch, o = !0) {
    ...
    for (let a = 0; a < i.childCount; a++) {
        ...
        if (!u) s.push(new ge(l, d, E.empty))
        else {
            r = u
            ...
            if (o && c.isText && n.whitespace != 'pre') {
                ...
                for (; (f = h.exec(c.text)); )
                    p ||
                        ...
                        s.push(
                            new ge(l + f.index, l + f.index + f[0].length, p),
                        )
            }
        }
        l = d
...
function at(t) {
    ...
    for (let r = t.depth, o = 0, i = 0; ; --r) {
        ...
        if (r == 0 || s.type.spec.isolating || !Ap(s, l, a)) break
...
function Ep(t, e, n) {
    ...
    for (let p = i, m = !1; p > n; p--)
        m || r.index(p) > 0
            ? ((m = !0), (d = S.from(r.node(p).copy(d))), u++)
            : a--
    let f = S.empty,
        h = 0
    for (let p = i, m = !1; p > n; p--)
        m || o.after(p + 1) < o.end(p)
            ? ((m = !0), (f = S.from(o.node(p).copy(f))), h++)
            : c++
    t.step(new ie(a, c, s, l, new E(d.append(f), u, h), d.size - u, !0))
}
...
function Rp(t, e, n) {
    ...
    let o = e.start,
        i = e.end
    t.step(new ie(o, i, o, i, new E(r, 0, 0), n.length, !0))
}
function Dp(t, e, n, r, o) {
    ...
    t.doc.nodesBetween(e, n, (s, l) => {
        ...
        if (
            s.isTextblock &&
            !s.hasMarkup(r, a) &&
            Ip(t.doc, t.mapping.slice(i).map(l), r)
        ) {
            let c = null
            ...
            return (
                t.step(
                    new ie(
                        ...
                        u + 1,
                        f - 1,
                        new E(S.from(r.create(a, null, s.marks)), 0, 0),
                        1,
                        !0,
                    ),
                ),
...
function Lp(t, e, n = 1, r) {
    ...
    t.step(new ge(e, e, new E(i.append(s), n, n), !0))
}
function Oe(t, e) {
    let n = t.resolve(e),
        r = n.index()
    return _a(n.nodeBefore, n.nodeAfter) && n.parent.canReplace(r, r + 1)
}
function Bp(t, e) {
...
function Ft(t, e, n = -1) {
    ...
    for (let o = r.depth; ; o--) {
        ...
        if (
            ...
            i && !i.isTextblock && _a(i, s) && r.node(o).canReplace(l, l + 1))
        )
            return e
        if (o == 0) break
...
function _n(t, e, n = e, r = E.empty) {
    ...
    let o = t.resolve(e),
        i = t.resolve(n)
    return Wa(o, i, r) ? new ge(e, n, r) : new Bi(o, i, r).fit()
}
function Wa(t, e, n) {
    return (
        !n.openStart &&
...
var Bi = class {
    ...
    fit() {
        ...
        let a = new E(i, s, l)
        return e > -1
            ? new ie(r.pos, e, this.$to.pos, this.$to.end(), a, n)
            : a.size || r.pos != this.$to.pos
              ? new ge(r.pos, o.pos, a)
              : null
    }
    findFittable() {
    ...
    dropNode() {
        ...
        if (o.childCount <= 1 && n > 0) {
            ...
            this.unplaced = new E(Bn(e, n - 1, 1), n - 1, i ? n - 1 : r)
        } else this.unplaced = new E(Bn(e, n, 1), n, r)
    }
    placeNodes({
        sliceDepth: e,
        frontierDepth: n,
        ...
        p || (h = -1),
            (this.placed = zn(this.placed, n, S.from(d))),
        ...
        this.unplaced = p
            ...
            : new E(Bn(s.content, e, c), s.openStart, s.openEnd)
    }
    mustMoveInline() {
    ...
    openFrontierNode(e, n = null, r) {
        ...
        ;(o.match = o.match.matchType(e)),
            (this.placed = zn(this.placed, this.depth, S.from(e.create(n, r)))),
...
function Bn(t, e, n) {
    return e == 0
        ...
        : t.replaceChild(
              0,
              t.firstChild.copy(Bn(t.firstChild.content, e - 1, n)),
          )
}
function zn(t, e, n) {
    return e == 0
...
function Pi(t, e, n, r, o) {
    ...
    return l && !$p(n, i.content, s) ? l : null
}
function $p(t, e, n) {
...
function Vp(t, e, n, r) {
    ...
    let o = t.doc.resolve(e),
        i = t.doc.resolve(n)
    if (Wa(o, i, r)) return t.step(new ge(e, n, r))
    let s = Ka(o, i)
            ...
            for (let m = 0; m < s.length; m++) {
                ...
                if (b.canReplaceWith(x, x, p.type, p.marks))
                    return t.replace(
                        o.before(g),
                        y ? i.after(g) : n,
                        new E(Ua(r.content, 0, r.openStart, h), h, r.openEnd),
                    )
            }
    }
...
function Ua(t, e, n, r, o) {
    if (e < n) {
        let i = t.firstChild
        t = t.replaceChild(0, i.copy(Ua(i.content, e + 1, n, r, i)))
    }
    if (e > r) {
...
function _p(t, e, n, r) {
    if (!r.isInline && e == n && t.doc.resolve(e).parent.content.size) {
        let o = Hp(t.doc, e, r.type)
        o != null && (e = n = o)
    }
    t.replaceRange(e, n, new E(S.from(r), 0, 0))
}
function Wp(t, e, n) {
...
var St = class {
    ...
    replace(e, n = e, r = E.empty) {
        let o = _n(this.doc, e, n, r)
        return o && this.step(o), this
    }
    replaceWith(e, n, r) {
        return this.replace(e, n, new E(S.from(r), 0, 0))
    }
    delete(e, n) {
    ...
    replaceRangeWith(e, n, r) {
        return _p(this, e, n, r), this
    }
    deleteRange(e, n) {
        return Wp(this, e, n), this
    }
    lift(e, n) {
        return Ep(this, e, n), this
    }
    join(e, n = 1) {
        return zp(this, e, n), this
    }
    wrap(e, n) {
        return Rp(this, e, n), this
    }
    setBlockType(e, n = e, r, o = null) {
        return Dp(this, e, n, r, o), this
    }
...
var $i = Object.create(null),
    P = class {
        ...
        static near(e, n = 1) {
            return (
                this.findFrom(e, n) || this.findFrom(e, -n) || new xe(e.node(0))
            )
        }
        static atStart(e) {
            return fn(e, e, 0, 0, 1) || new xe(e)
        }
        static atEnd(e) {
            return fn(e, e, e.content.size, e.childCount, -1) || new xe(e)
        }
        static fromJSON(e, n) {
            if (!n || !n.type)
...
var R = class t extends P {
    ...
    static between(e, n, r) {
        ...
        if (((!r || o) && (r = o >= 0 ? 1 : -1), !n.parent.inlineContent)) {
            let i = P.findFrom(n, r, !0) || P.findFrom(n, -r, !0)
            if (i) n = i.$head
        ...
        return (
            e.parent.inlineContent ||
                (o == 0
                    ? (e = n)
                    : ((e = (P.findFrom(e, -r, !0) || P.findFrom(e, r, !0))
                          .$anchor),
                      e.pos < n.pos != o < 0 && (e = n))),
            new t(e, n)
        )
...
var Vi = class t {
        ...
        resolve(e) {
            let n = e.resolve(this.anchor),
                r = n.nodeAfter
            return r && L.isSelectable(r) ? new L(n) : P.near(n)
        }
    },
    xe = class t extends P {
        constructor(e) {
...
function fn(t, e, n, r, o, i = !1) {
    ...
    for (
        ...
        if (l.isAtom) {
            ...
            let a = fn(t, l, n + o, o < 0 ? l.childCount : 0, o, i)
            if (a) return a
        }
        n += l.nodeSize * o
    }
...
function Ga(t, e, n) {
    ...
    if (r < e) return
    let o = t.steps[r]
    if (!(o instanceof ge || o instanceof ie)) return
    let i = t.mapping.maps[r],
        s
    i.forEach((l, a, c, d) => {
        s == null && (s = d)
    }),
        t.setSelection(P.near(t.doc.resolve(s), n))
}
var Xa = 1,
    Pr = 2,
    Ya = 4,
                    ...
                    : this.deleteSelection()
            {
                ...
                return (
                    ...
                    !this.selection.empty &&
                        ...
                        this.setSelection(P.near(this.selection.$to)),
                    this
                )
            }
        }
...
var Vt = class {
    ...
    Up = [
        ...
        new Vt('selection', {
            init(t, e) {
                return t.selection || P.atStart(e.doc)
            },
            apply(t) {
                return t.selection
            },
                ...
                n &&
                    n.forEach((r) => {
                        ...
                        this.plugins.push(r),
                            ...
                            r.spec.state &&
                                this.fields.push(new Vt(r.key, r.spec.state, r))
                    })
        }
    },
    Br = class t {
        ...
        static create(e) {
            let n = new Wn(e.doc ? e.doc.type.schema : e.schema, e.plugins),
                r = new t(n)
        ...
        reconfigure(e) {
            let n = new Wn(this.schema, e.plugins),
                r = n.fields,
                o = new t(n)
        ...
        static fromJSON(e, n, r) {
            ...
            let o = new Wn(e.schema, e.plugins),
                i = new t(o)
            return (
                o.fields.forEach((s) => {
                    if (s.name == 'doc') i.doc = ae.fromJSON(e.schema, n.doc)
                    else if (s.name == 'selection')
                        i.selection = P.fromJSON(i.doc, n.selection)
...
var ji = (t, e, n) => {
        ...
        if (r.parent.content.size == 0 && (pn(i, 'end') || L.isSelectable(i)))
            for (let s = r.depth; ; s--) {
                let l = _n(t.doc, r.before(s), r.after(s), E.empty)
...
var qi = (t, e, n) => {
        ...
        if (
            ...
            (pn(i, 'start') || L.isSelectable(i))
        ) {
            let s = _n(t.doc, r.before(), r.after(), E.empty)
            if (s && s.slice.size < s.to - s.from) {
                if (e) {
                    let l = t.tr.step(s)
                    l.setSelection(
                        pn(i, 'start')
                            ? P.findFrom(l.doc.resolve(l.mapping.map(o.pos)), 1)
...
var Qi = (t, e) => {
    ...
    Zi = (t, e) => {
        let n = t.selection,
            { $from: r, $to: o } = n
        if (n instanceof xe || r.parent.inlineContent || o.parent.inlineContent)
            return !1
        let i = Yi(o.parent.contentMatchAt(o.indexAfter()))
...
function Kp(t) {
    return (e, n) => {
        ...
        for (let h = r.depth; ; h--)
            if (r.node(h).isBlock) {
                ;(a = r.end(h) == r.pos + (r.depth - h)),
                    ...
                    (l = Yi(r.node(h - 1).contentMatchAt(r.indexAfter(h - 1))))
        ...
        let d = e.tr
        ;(e.selection instanceof R || e.selection instanceof xe) &&
            d.deleteSelection()
...
var dc = (t, e) => {
    ...
    Jp = (t, e) => (e && e(t.tr.setSelection(new xe(t.doc))), !0)
function Gp(t, e, n) {
    let r = e.nodeBefore,
        o = e.nodeAfter,
        i = e.index()
...
function uc(t, e, n, r) {
    ...
    let d = i.type.spec.isolating || (r > 0 && a) ? null : P.findFrom(e, 1),
    ...
    if (c && pn(i, 'start', !0) && pn(o, 'end')) {
        ...
        if (h.canReplace(h.childCount, h.childCount, m.content)) {
            if (n) {
                let y = S.empty
                for (let x = p.length - 1; x >= 0; x--) y = S.from(p[x].copy(y))
                let b = t.tr.step(
                    new ie(
                        e.pos - p.length,
                        e.pos + i.nodeSize,
...
function pc(t, e = null) {
    return function (n, r) {
        ...
        if (!s) return !1
        let l = r ? n.tr : null
        return Yp(l, s, t, e) ? (r && r(l.scrollIntoView()), !0) : !1
    }
}
function Yp(t, e, n, r = null) {
    let o = !1,
        i = e,
        s = e.$from.doc
    if (
    ...
    i < s &&
        (o.step(
            new ie(
                ...
                i,
                s,
                new E(S.from(n.create(null, r.parent.copy())), 1, 0),
                1,
                !0,
            ),
        ),
...
function em(t, e, n) {
    ...
    if (
        !c.canReplace(
            d + (l ? 0 : 1),
            d + 1,
            s.content.append(a ? S.empty : S.from(o)),
        )
    )
        return !1
    let u = i.pos,
    ...
    return (
        r.step(
            new ie(
                ...
                f - 1,
                new E(
                    (l ? S.empty : S.from(o.copy(S.empty))).append(
                        a ? S.empty : S.from(o.copy(S.empty)),
                    ),
                    l ? 0 : 1,
                    a ? 0 : 1,
                ),
    ...
    return function (e, n) {
        ...
        if (n) {
            let c = a.lastChild && a.lastChild.type == l.type,
                d = S.from(c ? t.create() : null),
                u = new E(
                    S.from(t.create(null, S.from(l.type.create(null, d)))),
                    c ? 3 : 1,
                    0,
                ),
                f = i.start,
            ...
            n(
                e.tr
                    .step(new ie(f - (c ? 3 : 1), h, f, h, u, 1, !0))
                    .scrollIntoView(),
            )
        }
        return !0
...
function rm(t, e) {
    for (;;) {
        ...
        } else if (t.parentNode && !Yn(t)) (e = fe(t)), (t = t.parentNode)
        else return null
    }
}
function om(t, e) {
    for (;;) {
        ...
        } else if (t.parentNode && !Yn(t)) (e = fe(t) + 1), (t = t.parentNode)
        else return null
    }
}
function im(t, e, n) {
...
var qe = typeof navigator < 'u' ? navigator : null,
    bc = typeof document < 'u' ? document : null,
    Nt = (qe && qe.userAgent) || '',
    fs = /Edge\/(\d+)/.exec(Nt),
    Xc = /MSIE \d/.exec(Nt),
    hs = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Nt),
    Ce = !!(Xc || hs || fs),
    At = Xc ? document.documentMode : hs ? +hs[1] : fs ? +fs[1] : 0,
    Ie = !Ce && /gecko\/(\d+)/i.test(Nt)
Ie && +(/Firefox\/(\d+)/.exec(Nt) || [0, 0])[1]
var ps = !Ce && /Chrome\/(\d+)/.exec(Nt),
    de = !!ps,
    Yc = ps ? +ps[1] : 0,
    be = !Ce && !!qe && /Apple Computer/.test(qe.vendor),
    xn = be && (/Mobile\/\w+/.test(Nt) || (!!qe && qe.maxTouchPoints > 2)),
    Re = xn || (qe ? /Mac/.test(qe.platform) : !1),
    Qc = qe ? /Win/.test(qe.platform) : !1,
    ut = /Android \d/.test(Nt),
    Qn = !!bc && 'webkitFontSmoothing' in bc.documentElement.style,
    am = Qn
...
function um(t) {
    ...
    return { refDOM: r, refTop: o, stack: Zc(t.dom) }
}
function Zc(t) {
    let e = [],
        n = t.ownerDocument
...
function fm({ refDOM: t, refTop: e, stack: n }) {
            ...
            if (p.top <= s && p.bottom >= l) {
                ...
                if (m < r) {
                    ;(n = d),
                        ...
                        d.nodeType == 1 &&
                            m &&
                            (i = u + (e.left >= (p.left + p.right) / 2 ? 1 : 0))
                    continue
                }
            } else
                p.top > e.top &&
...
function bm(t, e) {
    ...
    if (!s || !t.dom.contains(s.nodeType != 1 ? s.parentNode : s)) {
        ...
        if (!Ns(e, c) || ((s = nd(t.dom, e, c)), !s)) return null
    }
    if (be) for (let c = s; r && c; c = wn(c)) c.draggable && (r = void 0)
    if (((s = mm(s, e)), r)) {
        if (
            Ie &&
            r.nodeType == 1 &&
...
function rd(t, e, n) {
    ...
    if (r.nodeType == 3)
        if (
            s &&
            (wm.test(r.nodeValue) || (n < 0 ? !o : o == r.nodeValue.length))
        ) {
            let a = vt(dt(r, o, o), n)
            if (
                Ie &&
                ...
                let c = vt(dt(r, o - 1, o - 1), -1)
                if (c.top == a.top) {
                    let d = vt(dt(r, o, o + 1), -1)
                    if (d.top != a.top) return jn(d, d.left < c.left)
                }
            }
            return a
        } else {
        ...
        let c = a
            ? a.nodeType == 3
                ...
                : a.nodeType == 1
                  ...
                  : null
            : null
        if (c) return jn(vt(c, -1), !0)
    }
    return jn(vt(r.nodeType == 3 ? dt(r) : r, -n), n >= 0)
}
function jn(t, e) {
...
function Sm(t, e, n) {
    ...
    let o = r.parentOffset,
        ...
        l = t.domSelection()
    return l
        ? !km.test(r.parent.textContent) || !l.modify
            ? n == 'left' || n == 'backward'
                ? i
                : s
            : od(t, e, () => {
                  ...
                  try {
                      l.collapse(d, u),
                          a && (a != d || c != u) && l.extend && l.extend(a, c)
                  } catch {}
...
function Cm(t, e, n) {
    return kc == e && Sc == n
        ...
        : ((kc = e),
          (Sc = n),
          (Cc = n == 'up' || n == 'down' ? xm(t, e, n) : Sm(t, e, n)))
}
var Pe = 0,
    vc = 1,
    Wt = 2,
    ...
    Et = class t extends Gt {
        ...
        updateChildren(e, n) {
            ...
            Am(
                ...
                (a.changed || this.dirty == Wt) &&
                    ...
                    id(this.contentDOM, this.children, e),
                    xn && Em(this.dom))
        }
        localCompositionInfo(e, n) {
            ...
            if (this.node.inlineContent) {
                let s = i.nodeValue,
                    l = Nm(this.node.content, s, r - n, o - n)
...
function Mc(t, e, n, r, o) {
    ld(r, e, t)
    let i = new Et(void 0, t, e, n, r, r, r, o, 0)
...
Un.prototype = Object.create(null)
var jt = [new Un()]
function ys(t, e, n) {
    ...
    for (let i = 0; i < t.length; i++) {
        ...
        if (s) {
            s.nodeName && o.push((r = new Un(s.nodeName)))
            for (let l in s) {
                let a = s[l]
                a != null &&
                    (n &&
                        o.length == 1 &&
                        o.push((r = new Un(e.isInline ? 'span' : 'div'))),
                    l == 'class'
...
function ld(t, e, n) {
    return sd(t, t, jt, ys(e, n, t.nodeType != 1))
}
function Vr(t, e) {
    if (t.length != e.length) return !1
...
var bs = class {
    ...
    syncToMarks(e, n, r) {
        ...
        for (; i < e.length; ) {
            ...
            if (l > -1)
                ...
                let a = kn.create(this.top, e[i], n, r)
    ...
    recreateWrapper(e, n, r, o, i, s) {
        if (
            ...
            return null
        let l = Et.create(this.top, n, r, o, i, s)
        if (l.contentDOM) {
    ...
    addNode(e, n, r, o, i) {
        let s = Et.create(this.top, e, n, r, o, i)
...
function Os(t, e = null) {
    ...
    if (Jr(n)) {
        ...
        if (
            ...
            L.isSelectable(u) &&
            o.parent &&
            !(u.isInline && im(n.focusNode, n.focusOffset, o.dom))
        ) {
            let f = o.posBefore
            ...
            Ac &&
                ...
                n.visible
                    ...
                    : (t.dom.classList.add('ProseMirror-hideselection'),
                      'onselectionchange' in document && Om(t))
        }
...
function Ec(t, e) {
    ...
    if (be && o && o.contentEditable == 'false') return ls(o)
    if (
...
function ls(t) {
    return (
        ...
        be && t.draggable && ((t.draggable = !1), (t.wasDraggable = !0)),
        t
    )
}
function Nc(t) {
    ...
    e.addEventListener(
        ...
        (t.input.hideSelectionGuard = () => {
            ;(n.anchorNode != r || n.anchorOffset != o) &&
                ...
                setTimeout(() => {
                    ;(!ad(t) || t.state.selection.visible) &&
                        t.dom.classList.remove('ProseMirror-hideselection')
                }, 20))
        }),
    )
...
function Rc(t) {
    return t.editable && !t.hasFocus() ? !1 : dd(t)
}
function dd(t) {
    ...
    if (r instanceof R)
        if (n.indexOf('s') > -1) {
            ...
            if (t.endOfTextblock(e > 0 ? 'forward' : 'backward')) {
                let o = xs(t.state, e)
                return o && o instanceof L ? Mt(t, o) : !1
...
function Lm(t, e) {
    for (; t && e == t.childNodes.length && !Yn(t); )
...
function Bm(t, e) {
    for (; t && !e && !Yn(t); ) (e = fe(t)), (t = t.parentNode)
    for (; t && e; ) {
...
function ks(t, e, n) {
    if (e.nodeType != 3) {
        ...
        ;(s = Lm(e, n))
            ? ((e = s), (n = 0))
            : (i = Bm(e, n)) && ((e = i), (n = i.nodeValue.length))
    }
...
function Ic(t, e) {
    ...
    if (!(de || Qc) && n.parent.inlineContent) {
...
function Pc(t, e, n) {
    ...
    if (!o.parent.inlineContent || t.endOfTextblock(e < 0 ? 'up' : 'down')) {
        let s = xs(t.state, e)
        if (s && s instanceof L) return Mt(t, s)
    }
    if (!o.parent.inlineContent) {
        let s = e < 0 ? o : i,
            l = r instanceof xe ? P.near(s, e) : P.findFrom(s, e)
        return l ? Mt(t, l) : !1
    }
    return !1
}
...
function zm(t) {
    if (!be || t.state.selection.$head.parentOffset > 0) return !1
    ...
    if (
        ...
        let r = e.firstChild
        Bc(t, r, 'true'), setTimeout(() => Bc(t, r, 'false'), 20)
    }
    return !1
}
function Hm(t) {
...
function $m(t, e) {
    ...
    if (n == 37 || (Re && n == 66 && r == 'c')) {
        let o = n == 37 ? (Ic(t, t.state.selection.from) == 'ltr' ? -1 : 1) : -1
        return Dc(t, o, r) || gn(t, o)
    } else if (n == 39 || (Re && n == 70 && r == 'c')) {
        let o = n == 39 ? (Ic(t, t.state.selection.from) == 'ltr' ? 1 : -1) : 1
        return Dc(t, o, r) || gn(t, o)
    } else {
        if (n == 38 || (Re && n == 80 && r == 'c'))
            return Pc(t, -1, r) || gn(t, -1)
        if (n == 40 || (Re && n == 78 && r == 'c'))
            return zm(t) || Pc(t, 1, r) || gn(t, 1)
...
`,
    ...
    if (
        ...
        l = Um(zc(l, +d[1], +d[2]), d[4])
    else if (
        ((l = E.maxOpen(Vm(l.content, o), !0)), l.openStart || l.openEnd)
    ) {
        let u = 0,
            f = 0
        for (
    ...
    for (let n = e.depth; n >= 0; n--) {
        ...
        if (
            (t.forEach((l) => {
                ...
                if (
                    (c =
                        s.length && i.length && pd(a, i, l, s[s.length - 1], 0))
                )
                    s[s.length - 1] = c
                else {
                    s.length &&
                        (s[s.length - 1] = md(s[s.length - 1], i.length))
                    let d = hd(l, a)
...
function hd(t, e, n = 0) {
    for (let r = e.length - 1; r >= n; r--) t = e[r].create(null, S.from(t))
    return t
}
function pd(t, e, n, r, o) {
    if (o < t.length && o < e.length && t[o] == e[o]) {
        let i = pd(t, e, n, r.lastChild, o + 1)
        ...
        if (
            ...
            return r.copy(r.content.append(S.from(hd(n, t, o + 1))))
    }
}
function md(t, e) {
    if (e == 0) return t
    let n = t.content.replaceChild(t.childCount - 1, md(t.lastChild, e - 1)),
        r = t.contentMatchAt(t.childCount).fillBefore(S.empty, !0)
...
function Wm(t) {
    ...
    let n = yd().createElement('div'),
        r = /<([a-z][^>\s]+)/i.exec(t),
        o
    if (
        ((o = r && gd[r[1].toLowerCase()]) &&
            (t =
                o.map((i) => '<' + i + '>').join('') +
                t +
                o
...
function qm(t) {
    for (let e in ke) {
        ...
        t.dom.addEventListener(
            ...
            Km[e] ? { passive: !0 } : void 0,
        )
    }
    be && t.dom.addEventListener('input', () => null), vs(t)
}
function Tt(t, e) {
...
Se.keydown = (t, e) => {
    ...
    if (
        ...
        if (
            ...
            t.someProp('handleKeyDown', (r) => r(t, n)) || $m(t, n)
                ? n.preventDefault()
                : Tt(t, 'key')
}
Se.keyup = (t, e) => {
...
function Zm(t, e) {
    ...
    return o != null ? (bn(t, L.create(t.state.doc, o), 'pointer'), !0) : !1
}
...
function rg(t, e, n) {
    ...
    for (let i = o.depth + 1; i > 0; i--) {
        ...
        else if (L.isSelectable(s)) bn(t, L.create(r, l), 'pointer')
        else continue
        return !0
    }
}
    ...
    up(e) {
        ...
        this.view.state.doc != this.startDoc &&
            ...
            this.allowDefault || !n
                ...
                : eg(this.view, n.pos, n.inside, e, this.selectNode)
                  ? e.preventDefault()
                  : e.button == 0 &&
                      (this.flushed ||
                          (be &&
                    ...
                    ? (bn(
                          this.view,
                          P.near(this.view.state.doc.resolve(n.pos)),
                          'pointer',
                      ),
                      e.preventDefault())
                    : Tt(this.view, 'pointer')
...
ke.contextmenu = (t) => Ls(t)
function wd(t, e) {
    return t.composing
        ? !0
        : be && Math.abs(e.timeStamp - t.input.compositionEndedAt) < 500
...
function kd(t) {
    for (
        t.composing &&
        ((t.input.composing = !1), (t.input.compositionEndedAt = lg()));
...
function sg(t) {
    ...
    let n = rm(e.focusNode, e.focusOffset),
        r = om(e.focusNode, e.focusOffset)
    if (n && r && n != r) {
        let o = r.pmViewDesc,
...
function dg(t, e) {
    ...
    setTimeout(() => {
        t.focus(),
            ...
            n
                ? Jn(t, r.value, null, o, e)
                : Jn(t, r.textContent, r.innerHTML, o, e)
    }, 50)
}
function Jn(t, e, n, r, o) {
    let i = fd(t, e, n, r, t.state.selection.$from)
...
Se.paste = (t, e) => {
    ...
    r && Jn(t, Sd(r), r.getData('text/html'), o, n)
        ? n.preventDefault()
        : dg(t, n)
}
var jr = class {
...
ke.dragstart = (t, e) => {
    ...
    let o = t.state.selection,
        i = o.empty ? null : t.posAtCoords(Gr(n)),
        s
    if (
    ...
    let l = (s || t.state.selection).content(),
        { dom: a, text: c, slice: d } = Ds(t, l)
    ;(!n.dataTransfer.files.length || !de || Yc > 120) &&
...
function fg(t, e, n) {
    ...
    if (!i) return
    e.preventDefault()
    let l = i ? Ir(t.state.doc, o.pos, i) : o.pos
    l == null && (l = o.pos)
    let a = t.state.tr
    if (s) {
        let { node: h } = n
    ...
    if (
        ...
        a.mapping.maps[a.mapping.maps.length - 1].forEach(
            ...
            a.setSelection(Rs(t, f, a.doc.resolve(h)))
    }
...
ke.beforeinput = (t, e) => {
    if (de && ut && e.inputType == 'deleteContentBackward') {
        ...
        setTimeout(() => {
            if (
                ...
                (t.dom.blur(),
                t.focus(),
                t.someProp('handleKeyDown', (i) => i(t, _t(8, 'Backspace'))))
            )
                return
...
var Ur = class t {
    ...
    ee = class t {
        ...
        static widget(e, n, r) {
            return new t(e, e, new Ur(n, r))
        }
        static inline(e, n, r, o) {
            return new t(e, n, new Ut(r, o))
        }
        static node(e, n, r, o) {
    ...
    X = class t {
        constructor(e, n) {
            ;(this.local = e.length ? e : yn),
                (this.children = n.length ? n : yn)
        }
        static create(e, n) {
            return n.length ? qr(n, e, 0, Kt) : ye
        }
        find(e, n, r) {
            let o = []
        ...
        map(e, n, r) {
            return this == ye || e.maps.length == 0
                ? this
        ...
        forChild(e, n) {
            ...
            for (let l = 0; l < this.local.length; l++) {
                let a = this.local[l]
                if (a.from < s && a.to > i && a.type instanceof Ut) {
            ...
            if (o) {
                let l = new t(o.sort(qt), yn)
                return r ? new Kr([l, r]) : l
            }
            return r || ye
        }
        eq(e) {
        ...
        localsInner(e) {
            if (this == ye) return yn
            if (e.inlineContent || !this.local.some(Ut.is)) return this.local
            let n = []
            for (let r = 0; r < this.local.length; r++)
                this.local[r].type instanceof Ut || n.push(this.local[r])
            return n
        }
        forEachSet(e) {
            e(this)
...
function qr(t, e, n, r) {
    ...
    e.forEach((l, a) => {
        ...
        if (c) {
            i = !0
            let d = qr(c, l, n + a + 1, r)
            d != ye && o.push(a, a + l.nodeSize, d)
        }
    })
    let s = vd(i ? Td(t) : t, -n).sort(qt)
    for (let l = 0; l < s.length; l++)
        s[l].type.valid(e, s[l]) ||
            (r.onRemove && r.onRemove(s[l].spec), s.splice(l--, 1))
    return s.length || o.length ? new X(s, o) : ye
}
function qt(t, e) {
    ...
    Es = class {
        ...
        start() {
            this.observer &&
                ...
                this.observer.observe(this.view.dom, mg)),
                this.onCharData &&
        ...
        onSelectionChange() {
            if (Rc(this.view)) {
                ...
                if (Ce && At <= 11 && !this.view.state.selection.empty) {
        ...
        flush() {
            ...
            c.eq(P.near(e.state.doc.resolve(0), 1))
                ? ((e.input.lastFocus = 0),
                  ...
                  e.scrollToSelection())
                : (i > -1 || o) &&
                  (i > -1 && (e.docView.markDirty(i, s), yg(e)),
        ...
        registerMutation(e, n) {
            ...
            if (e.type == 'childList') {
                ...
                let o = e.previousSibling,
                    i = e.nextSibling
                if (Ce && At <= 11 && e.addedNodes.length)
                    for (let d = 0; d < e.addedNodes.length; d++) {
...
function yg(t) {
    if (
        ...
        if (((t.requiresGeckoHackNode = Ie), Vc)) return
        console.warn(
...
function xg(t, e, n) {
    ...
    let u = t.state.doc,
        f = t.someProp('domParser') || Ke.fromSchema(t.state.schema),
        h = u.resolve(s),
        p = null,
        m = f.parse(r, {
            topNode: h.parent,
...
function kg(t) {
    ...
    if (t.nodeName == 'BR' && t.parentNode) {
        if (be && /^(ul|ol)$/i.test(t.parentNode.nodeName)) {
            ...
            (be && /^(tr|table)$/i.test(t.parentNode.nodeName))
        )
            return { ignore: !0 }
...
function Cg(t, e, n, r, o) {
    ...
    if (((t.input.compositionPendingChanges = 0), e < 0)) {
        ...
        if (T && !t.state.selection.eq(T)) {
            if (
                ...
                t.someProp('handleKeyDown', (A) => A(t, _t(13, 'Enter')))
            )
                return
            let O = t.state.tr.setSelection(T)
            k == 'pointer'
                ? O.setMeta('pointer', !0)
                : k == 'key' && O.scrollIntoView(),
                i && O.setMeta('composition', i),
                t.dispatch(O)
        }
        return
    }
    ...
    let p = Tg(u.content, c.doc.content, c.from, f, h)
    if (
        (p && t.input.domChangeCount++,
        ((xn && t.input.lastIOSEnter > Date.now() - 225) || ut) &&
            o.some((k) => k.nodeType == 1 && !Sg.test(k.nodeName)) &&
            (!p || p.endA >= p.endB) &&
            t.someProp('handleKeyDown', (k) => k(t, _t(13, 'Enter'))))
    ) {
        t.input.lastIOSEnter = 0
        return
    }
    ...
    if (
        ((xn &&
            ...
            (!b || o.some((k) => k.nodeName == 'DIV' || k.nodeName == 'P'))) ||
            (!b &&
    ...
    if (
        ...
        Mg(d, p.start, p.endA, m, g) &&
        t.someProp('handleKeyDown', (k) => k(t, _t(8, 'Backspace')))
    ) {
        ut && de && t.domObserver.suppressSelectionUpdates()
        return
    }
                ...
                O &&
                    !(
                        (de &&
                            ...
                            (O.head == x || O.head == T.mapping.map(v) - 1)) ||
                        (Ce && O.empty && O.head == x)
                    ) &&
                    T.setSelection(O)
            }
            return i && T.setMeta('composition', i), T.scrollIntoView()
        },
        C
    if (b)
        if (m.pos == g.pos) {
            Ce &&
                ...
                setTimeout(() => ft(t), 20))
            let k = w(t.state.tr.delete(x, v)),
                T = d.resolve(p.start).marksAcross(d.resolve(p.endA))
            T && k.ensureMarks(T), t.dispatch(k)
        } else if (
            p.endA == p.endB &&
            (C = vg(
            ...
            let k = w(t.state.tr)
            C.type == 'add'
                ? k.addMark(x, v, C.mark)
                : k.removeMark(x, v, C.mark),
                t.dispatch(k)
        } else if (
            ...
            let k = m.parent.textBetween(m.parentOffset, g.parentOffset),
                T = () => w(t.state.tr.insertText(k, x, v))
            t.someProp('handleTextInput', (O) => O(t, x, v, k, T)) ||
                t.dispatch(T())
        } else t.dispatch(w())
    else t.dispatch(w())
}
...
function vg(t, e) {
    ...
    if (S.from(c).eq(t)) return { mark: l, type: s }
}
...
var Xn = class {
    ...
    updateStateInner(e, n) {
        ...
        let o = this.state,
            i = !1,
            s = !1
        e.storedMarks && this.composing && (kd(this), (s = !0)),
            (this.state = e)
        ...
        if (
            ...
            let h = Jc(this)
            Eg(h, this.nodeViews) && ((this.nodeViews = h), (i = !0))
        }
        ...
        if (s) {
            ...
            let h =
                ...
                !o.selection.empty &&
                !e.selection.empty &&
                Ag(o.selection, e.selection)
            if (u) {
                let p = de
                    ? (this.trackWrites = this.domSelectionRange().focusNode)
                    : null
                this.composing && (this.input.compositionNode = sg(this)),
            ...
            !(
                ...
                ? ft(this, h)
                : (cd(this, e.selection), this.domObserver.setCurSelection()),
                this.domObserver.start()
        }
    ...
    domSelectionRange() {
        ...
        return e
            ? (be &&
                  ...
                  sm(this.dom.ownerDocument) == this.dom &&
                  bg(this, e)) ||
                  e
            : {
                  focusNode: null,
...
Xn.prototype.dispatch = function (t) {
...
function Uc(t) {
    ...
    return (
        ...
        [ee.node(0, t.state.doc.content.size, e)]
    )
}
function Kc(t) {
    if (t.markCursor) {
        ...
        ;(e.className = 'ProseMirror-separator'),
            ...
            (t.cursorWrapper = {
                dom: e,
                deco: ee.widget(t.state.selection.from, e, {
                    raw: !0,
                    marks: t.markCursor,
                }),
            })
...
var ht = {
    ...
    Ng = typeof navigator < 'u' && /Mac/.test(navigator.platform),
    Og =
        typeof navigator < 'u' &&
        /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(
            navigator.userAgent,
        )
for (se = 0; se < 10; se++) ht[48 + se] = ht[96 + se] = String(se)
var se
for (se = 1; se <= 24; se++) ht[se + 111] = 'F' + se
var se
for (se = 65; se <= 90; se++)
    (ht[se] = String.fromCharCode(se + 32)), (Yr[se] = String.fromCharCode(se))
var se
for (Xr in ht) Yr.hasOwnProperty(Xr) || (Yr[Xr] = ht[Xr])
var Xr
function Ad(t) {
    var e =
            (Ng && t.metaKey && t.shiftKey && !t.ctrlKey && !t.altKey) ||
            (Og && t.shiftKey && t.key && t.key.length == 1) ||
            t.key == 'Unidentified',
        n =
            (!e && t.key) ||
...
var Rg =
    ...
    Dg = typeof navigator < 'u' && /Win/.test(navigator.platform)
function Ig(t) {
    let e = t.split(/-(?!$)/),
        n = e[e.length - 1]
    n == 'Space' && (n = ' ')
    ...
    for (let l = 0; l < e.length - 1; l++) {
        ...
        else if (/^mod$/i.test(a)) Rg ? (s = !0) : (o = !0)
...
function Ed(t) {
    return new B({ props: { handleKeyDown: Zn(t) } })
}
function Zn(t) {
    let e = Pg(t)
    return function (n, r) {
...
var Lg = Object.defineProperty,
    Ws = (t, e) => {
        for (var n in e) Lg(t, n, { get: e[n], enumerable: !0 })
    }
function io(t) {
...
function Us(t, e, n) {
    ...
    let s = o.index,
        ...
        a = s + 1,
        c = l + o.node.nodeSize
    for (; s > 0 && Nd([...t.parent.child(s - 1).marks], e, n); )
        (s -= 1), (l -= t.parent.child(s).nodeSize)
    for (; a < t.parent.childCount && Nd([...t.parent.child(a).marks], e, n); )
...
var Yg =
        ...
        ({ editor: n, view: r, tr: o, dispatch: i }) => {
            ...
            let l = $d(o.doc, t) || n.state.selection,
...
function er(t, e, n) {
    if (t instanceof ae || t instanceof S) return t
    ...
    if (o) {
        if (n.errorOnInvalidContent) {
            ...
            if (
                (n.slice
                    ? Ke.fromSchema(a).parseSlice(Qr(t), n.parseOptions)
                    : Ke.fromSchema(a).parse(Qr(t), n.parseOptions),
            ...
            if (o) {
                ...
                if (f) {
                    ...
                    let g = r.doc.resolve(d),
                        y = g.node(),
                        b = g.parentOffset === 0,
                        x = y.isText || y.isTextblock,
                        v = y.content.size > 0
                    b && x && v && (d = Math.max(0, d - 1)),
                        r.replaceWith(d, u, m)
                }
                n.updateSelection && ey(r, r.steps.length - 1, -1),
                    n.applyInputRules &&
...
function uy(t) {
    ...
    for (let l = 0; l < e.length - 1; l += 1) {
        ...
        else if (/^mod$/i.test(a)) Ks() || Vd() ? (s = !0) : (o = !0)
        else throw new Error(`Unrecognized modifier name: ${a}`)
    }
    return (
        r && (n = `Alt-${n}`),
...
var yy =
        ...
        ({ tr: n, state: r, dispatch: o }) => {
            let i = null,
                s = null,
                l = ao(typeof t == 'string' ? t : t.name, r.schema)
            if (!l) return !1
            l === 'node' && (i = te(t, r.schema)),
                ...
                n.selection.ranges.forEach((c) => {
                    r.doc.nodesBetween(c.$from.pos, c.$to.pos, (d, u) => {
                        i &&
                            i === d.type &&
                            ((a = !0),
                            o && n.setNodeMarkup(u, void 0, Od(d.attrs, e))),
                            s &&
                                d.marks.length &&
                                d.marks.forEach((f) => {
                                    s === f.type &&
...
function J(t, e = void 0, ...n) {
    return jd(t) ? (e ? t.bind(e)(...n) : t(...n)) : t
}
function Ty(t = {}) {
...
function Ud(t) {
    let e = [],
        { nodeExtensions: n, markExtensions: r } = Cn(t),
        o = [...n, ...r],
        i = {
            default: null,
            validate: void 0,
...
function Ey(t, e) {
    var n
    let r = Ud(t),
        { nodeExtensions: o, markExtensions: i } = Cn(t),
        s = (n = o.find((c) => H(c, 'topNode'))) == null ? void 0 : n.name,
        l = Object.fromEntries(
            o.map((c) => {
                let d = r.filter((y) => y.type === c.name),
                    ...
                    f = t.reduce((y, b) => {
                        let x = H(b, 'extendNodeSchema', u)
                        return { ...y, ...(x ? x(c) : {}) }
                    }, {}),
                    h = Dd({
                        ...f,
                        content: J(H(c, 'content', u)),
                        marks: J(H(c, 'marks', u)),
                        group: J(H(c, 'group', u)),
                        inline: J(H(c, 'inline', u)),
                        atom: J(H(c, 'atom', u)),
                        selectable: J(H(c, 'selectable', u)),
                        draggable: J(H(c, 'draggable', u)),
                        code: J(H(c, 'code', u)),
                        whitespace: J(H(c, 'whitespace', u)),
                        linebreakReplacement: J(
                            H(c, 'linebreakReplacement', u),
                        ),
                        defining: J(H(c, 'defining', u)),
                        isolating: J(H(c, 'isolating', u)),
                        attrs: Object.fromEntries(d.map(Id)),
                    }),
                    p = J(H(c, 'parseHTML', u))
                p && (h.parseDOM = p.map((y) => Rd(y, d)))
                let m = H(c, 'renderHTML', u)
                m && (h.toDOM = (y) => m({ node: y, HTMLAttributes: oo(y, d) }))
                let g = H(c, 'renderText', u)
        ...
        a = Object.fromEntries(
            i.map((c) => {
                let d = r.filter((g) => g.type === c.name),
                    ...
                    f = t.reduce((g, y) => {
                        let b = H(y, 'extendMarkSchema', u)
                        return { ...g, ...(b ? b(c) : {}) }
                    }, {}),
                    h = Dd({
                        ...f,
                        inclusive: J(H(c, 'inclusive', u)),
                        excludes: J(H(c, 'excludes', u)),
                        group: J(H(c, 'group', u)),
                        spanning: J(H(c, 'spanning', u)),
                        code: J(H(c, 'code', u)),
                        attrs: Object.fromEntries(d.map(Id)),
                    }),
                    p = J(H(c, 'parseHTML', u))
                p && (h.parseDOM = p.map((g) => Rd(g, d)))
                let m = H(c, 'renderHTML', u)
                return (
                    m &&
                        (h.toDOM = (g) =>
                            m({ mark: g, HTMLAttributes: oo(g, d) })),
                    [c.name, h]
                )
            }),
        )
...
function Qs(t, e) {
    let n = ao(typeof e == 'string' ? e : e.name, t.schema)
    return n === 'node' ? Ry(t, e) : n === 'mark' ? _d(t, e) : {}
}
function Dy(t, e = JSON.stringify) {
    let n = {}
    return t.filter((r) => {
        let o = e(r)
        ...
        (o.forEach(({ $from: u, $to: f }) => {
            ...
            t.doc.nodesBetween(h, p, (m, g) => {
                ...
                let y = Math.max(h, g),
                    ...
                    x = b - y
                ;(s += x),
                    l.push(...m.marks.map((v) => ({ mark: v, from: y, to: b })))
            })
        }),
        s === 0)
    )
...
function el(t, e, n = {}) {
    if (!e) return Ge(t, null, n) || _s(t, null, n)
    let r = ao(e, t.schema)
    return r === 'node' ? Ge(t, e, n) : r === 'mark' ? _s(t, e, n) : !1
}
var Xd = (t, e) => {
        let { $from: n, $to: r, $anchor: o } = t.selection
        if (e) {
            let i = Xe((l) => l.type.name === e)(t.selection)
            if (!i) return !1
...
var Uy =
        ...
        ({ tr: e, state: n, dispatch: r, editor: o }) => {
            let { selection: i, doc: s } = e,
                ...
                d = no(c, l.node().type.name, l.node().attrs)
            if (i instanceof L && i.node.isBlock)
                return !l.parentOffset || !Ae(s, l.pos)
                    ? !1
                    : (r &&
                          (t && Bd(n, o.extensionManager.splittableMarks),
        ...
        ({ tr: n, state: r, dispatch: o, editor: i }) => {
            ...
            if (
                ...
                if (o) {
                    ...
                    for (let T = a.depth - b; T >= a.depth - 3; T -= 1)
                        y = S.from(a.node(T).copy(y))
                    let x =
                    ...
                    y = y.append(S.from(l.createAndFill(null, w) || void 0))
                    let C = a.before(a.depth - (b - 1))
                    n.replace(C, a.after(-x), new E(y, 4 - b, 0))
                    let k = -1
                    n.doc.nodesBetween(C, n.doc.content.size, (T, O) => {
                        if (k > -1) return !1
                        T.isTextblock && T.content.size === 0 && (k = O + 1)
                    }),
                        k > -1 && n.setSelection(R.near(n.doc.resolve(k))),
                        n.scrollIntoView()
                }
                return !0
            }
            let h = c.pos === a.end() ? u.contentMatchAt(0).defaultType : null,
                p = { ...no(f, u.type.name, u.attrs), ...e },
                m = { ...no(f, a.node().type.name, a.node().attrs), ...e }
            ...
            if (o) {
                let { selection: y, storedMarks: b } = r,
                    ...
                    v = b || (y.$to.parentOffset && y.$from.marks())
                if ((n.split(a.pos, 2, g).scrollIntoView(), !v || !o)) return !0
                let w = v.filter((C) => x.includes(C.type.name))
                n.ensureMarks(w)
            }
            return !0
        },
    $s = (t, e) => {
        let n = Xe((s) => s.type === e)(t.selection)
        if (!n) return !0
    ...
    qy =
        ...
        ({
            ...
            let { extensions: u, splittableMarks: f } = o.extensionManager,
                ...
                { $from: y, $to: b } = m,
                x = y.blockRange(b),
                v = g || (m.$to.parentOffset && m.$from.marks())
            if (!x) return !1
            let w = Xe((C) => Ld(C.type.name, u))(m)
            if (x.depth >= 1 && w && x.depth - w.depth <= 1) {
                if (w.node.type === h) return c.liftListItem(p)
                if (
                    Ld(w.node.type.name, u) &&
                    h.validContent(w.node.content) &&
                    l
                )
                    return a()
            ...
            return !n || !v || !l
                ...
                : a()
                      .command(() => {
                          let C = d().wrapInList(h, r),
                              k = v.filter((T) => f.includes(T.type.name))
                          return i.ensureMarks(k), C ? !0 : c.clearNodes()
                      })
                      .wrapInList(h, r)
                      .command(() => $s(i, h))
                      .command(() => Fs(i, h))
...
function Zr(t) {
    ...
    return (
        s.forEach((f) => {
            ...
            if (!h) return
            let p = a.state.tr,
                m = io({ state: a.state, transaction: p }),
    ...
    return (
        eo(t) &&
            ...
            Object.keys(e).forEach((r) => {
                eo(e[r]) && eo(t[r]) ? (n[r] = tu(t[r], e[r])) : (n[r] = e[r])
            }),
        n
    )
}
var tl = class {
        ...
        get options() {
            return { ...(J(H(this, 'addOptions', { name: this.name })) || {}) }
        }
        get storage() {
            return {
                ...(J(
...
function u0(t) {
    let {
        ...
        { commands: a, chain: c, can: d } = new so({ editor: e, state: n }),
        u = []
    return (
        n.doc.nodesBetween(r, o, (h, p) => {
            ...
            let k = h.isText
                ? h.text || ''
                : h.textBetween(w - p, C - p, void 0, '\uFFFC')
            d0(k, i.find, s).forEach((O) => {
                if (O.index === void 0) return
                let A = w + O.index + 1,
                    z = A + O[0].length,
                    V = { from: n.tr.mapping.map(A), to: n.tr.mapping.map(z) },
                    U = i.handler({
                        state: n,
                        range: V,
                        match: O,
            ...
            new B({
                ...
                appendTransaction: (u, f, h) => {
                    ...
                    let x = f.doc.content.findDiffStart(h.doc.content),
                        v = f.doc.content.findDiffEnd(h.doc.content)
                    if (!(!a0(x) || !v || x === v.b))
                        return a({
                            rule: d,
                            state: h,
...
var ho = class {
    constructor(t, e) {
        ;(this.splittableMarks = []),
            ...
            (this.extensions = Kd(t)),
            (this.schema = Ey(this.extensions, e)),
    ...
    get plugins() {
        ...
        return Ys([...this.extensions].reverse()).flatMap((r) => {
            ...
            let a = Ed(l)
            i.push(a)
            let c = H(r, 'addInputRules', o)
            if (Pd(r, t.options.enableInputRules) && c) {
                let f = c()
                if (f && f.length) {
                    let h = s0({ editor: t, rules: f }),
                        p = Array.isArray(h) ? h : [h]
                    i.push(...p)
                }
            }
            let d = H(r, 'addPasteRules', o)
            if (Pd(r, t.options.enablePasteRules) && d) {
                let f = d()
                if (f && f.length) {
                    let h = h0({ editor: t, rules: f })
                    i.push(...h)
                }
            }
            let u = H(r, 'addProseMirrorPlugins', o)
            if (u) {
                let f = u()
                i.push(...f)
            }
    ...
    get attributes() {
        return Ud(this.extensions)
    }
    get nodeViews() {
        let { editor: t } = this,
            { nodeExtensions: e } = Cn(this.extensions)
        return Object.fromEntries(
            e
                .filter((n) => !!H(n, 'addNodeView'))
                .map((n) => {
    ...
    get markViews() {
        let { editor: t } = this,
            { markExtensions: e } = Cn(this.extensions)
        return Object.fromEntries(
            e
                .filter((n) => !!H(n, 'addMarkView'))
                .map((n) => {
    ...
    setupExtensions() {
        ...
        ;(this.editor.extensionStorage = Object.fromEntries(
            ...
            t.forEach((e) => {
                ...
                e.type === 'mark' &&
                    ((n = J(H(e, 'keepOnSplit', r))) == null || n) &&
                    this.splittableMarks.push(e.name)
                let o = H(e, 'onBeforeCreate', r),
                    i = H(e, 'onCreate', r),
                    s = H(e, 'onUpdate', r),
                    l = H(e, 'onSelectionUpdate', r),
                    a = H(e, 'onTransaction', r),
                    c = H(e, 'onFocus', r),
                    d = H(e, 'onBlur', r),
                    u = H(e, 'onDestroy', r)
...
Ws(p0, {
    ...
    Tabindex: () => hu,
    TextDirection: () => pu,
    focusEventsPluginKey: () => cu,
})
var j = class ru extends tl {
        constructor() {
                ...
                new B({
                    ...
                    appendTransaction: (t, e, n) => {
                        ...
                        let { empty: i, from: s, to: l } = e.selection,
                            a = P.atStart(e.doc).from,
                            c = P.atEnd(e.doc).to
                        if (i || !(s === a && l === c) || !nr(n.doc)) return
                        let f = n.tr,
                            h = io({ state: n, transaction: f }),
                            { commands: p } = new so({
                                editor: this.editor,
                                state: h,
                            })
    ...
    pu = j.create({
        ...
        addGlobalAttributes() {
            ...
            let { nodeExtensions: t } = Cn(this.extensions)
            return [
                {
                    types: t
        ...
        get children() {
            ...
            return (
                this.node.content.forEach((n, r) => {
                    ...
                    let a = new Sn(l, this.editor, o, o ? n : null)
...
var mu = class extends o0 {
    constructor(t = {}) {
        super(),
            ...
            (this.utils = {
                getUpdatedPosition: Ly,
                createMappablePosition: By,
            }),
            this.setOptions(t),
        ...
        let e = this.createDoc(),
            n = $d(e, this.options.autofocus)
        ;(this.editorState = Br.create({
            doc: e,
            schema: this.schema,
            selection: n || void 0,
        })),
    ...
    injectCSS() {
        this.options.injectCSS &&
            typeof document < 'u' &&
            (this.css = y0(g0, this.options.injectNonce))
    }
    setOptions(t = {}) {
        ...
        let r = [
            ...(this.options.enableCoreExtensions
                ? [
                      ...
                      fu,
                      su,
                      pu.configure({ direction: this.options.textDirection }),
                  ].filter((o) =>
...
`,
        ...
        return Oy(this.state.doc, {
            blockSeparator: e,
            textSerializers: { ...Jd(this.schema), ...n },
        })
    }
    get isEmpty() {
...
var w0 = {}
Ws(w0, {
    createAtomBlockMarkdownSpec: () => x0,
    createBlockMarkdownSpec: () => Xt,
    createInlineMarkdownSpec: () => C0,
    parseAttributes: () => nl,
                ...
                for (k.lastIndex = 0; ; ) {
                    ...
                    if (!((p = O[2]) != null && p.endsWith(':::'))) {
                        if (z) v += 1
                            ...
                            let V = T.slice(0, A)
                            C = V.trim()
                            let U = u.slice(0, w + A + O[0].length),
                                _ = []
                            if (C)
                                if (l === 'block')
                                    for (
...
function C0(t) {
    let {
            ...
            name: n,
            getContent: r,
            parseAttributes: o = k0,
            serializeAttributes: i = S0,
            defaultAttributes: s = {},
            selfClosing: l = !1,
            allowedAttributes: a,
        } = t,
    ...
    return {
        ...
        markdownTokenizer: {
            ...
            tokenize(f, h, p) {
                ...
                let x = o(b.trim())
                return { type: e, raw: g[0], content: y.trim(), attributes: x }
            },
        },
        renderMarkdown: (f) => {
            let h = ''
...
`),
            ...
            if (
                (((s = (i = w.match(/^(\s*)/)) == null ? void 0 : i[1]) == null
                    ? void 0
                    : s.length) || 0) > m
            )
                y.push(w),
...
`),
        ...
        let b,
            x = y.slice(1)
        if (x.length > 0) {
            let w = x.map((C) => C.slice(m + u)).join(`
`)
            w.trim() &&
                (e.customNestedParser
                    ? (b = e.customNestedParser(w))
                    : (b = n.blockTokens(w)))
        }
        let v = e.createToken(p, b)
        a.push(v)
    }
...
var le = class t extends P {
    constructor(e) {
        super(e, e)
    }
    map(e, n) {
        let r = e.resolve(n.map(this.head))
        return t.valid(r) ? new t(r) : P.near(r)
    }
    content() {
        return E.empty
    }
    ...
    static valid(e) {
        let n = e.parent
        if (n.isTextblock || !M0(e) || !T0(e)) return !1
...
var il = class t {
    ...
    resolve(e) {
        ...
        return le.valid(n) ? new le(n) : P.near(n)
    }
}
function ku(t) {
...
function M0(t) {
    for (let e = t.depth; e >= 0; e--) {
        ...
        for (let o = r.child(n - 1); ; o = o.lastChild) {
            if ((o.childCount == 0 && !o.inlineContent) || ku(o.type)) return !0
    ...
    return new B({
        props: {
            ...
            createSelectionBetween(t, e, n) {
                return e.pos == n.pos && le.valid(n) ? new le(n) : null
            },
            handleClick: E0,
            handleKeyDown: A0,
...
function N0(t, e) {
    ...
    return i.setSelection(R.near(i.doc.resolve(n.pos + 1))), t.dispatch(i), !1
}
function O0(t) {
    if (!(t.selection instanceof le)) return null
    let e = document.createElement('div')
    return (
        (e.className = 'ProseMirror-gapcursor'),
        X.create(t.doc, [ee.widget(t.selection.head, e, { key: 'gapcursor' })])
    )
}
var yo = 200,
    he = function () {}
...
he.from = function (e) {
    return e instanceof he ? e : e && e.length ? new Cu(e) : he.empty
}
var Cu = (function (t) {
    function e(r) {
...
function L0(t, e, n, r) {
    ...
    n.getMeta(H0) && (t = new Ze(t.done, t.undone, null, 0, -1))
            ...
            a =
                ...
                (!s &&
                    ...
                    (t.prevTime < (n.time || 0) - r.newGroupDelay ||
                        !B0(n, t.prevRanges))),
            c = s ? ll(t.prevRanges, n.mapping) : vu(n.mapping.maps)
        return new Ze(
            t.done.addTransform(
                n,
...
function z0(t, e, n) {
    ...
    return i.transform.setSelection(s).setMeta(Yt, { redo: n, historyState: a })
}
var al = !1,
    Mu = null
function bo(t) {
...
var w1 = j.create({
    ...
    Nu = j.create({
        ...
        extendNodeSchema(t) {
            ...
            return {
                allowGapCursor:
                    (e = J(H(t, 'allowGapCursor', n))) != null ? e : null,
            }
        },
    }),
    ul = j.create({
...
`)
        ...
        addInputRules() {
            return [Ye({ find: $0, type: this.type })]
        },
    }),
    Ru = F0
var V0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/,
    _0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g,
    W0 = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/,
    j0 = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g,
    U0 = Z.create({
        name: 'bold',
        addOptions() {
            return { HTMLAttributes: {} }
        ...
        addInputRules() {
            return [
                Le({ find: V0, type: this.type }),
                Le({ find: W0, type: this.type }),
            ]
        },
        addPasteRules() {
            return [
                ve({ find: _0, type: this.type }),
                ve({ find: j0, type: this.type }),
            ]
        },
    }),
    Du = U0
var K0 = /(^|[^`])`([^`]+)`(?!`)$/,
    ...
    J0 = Z.create({
        ...
        addInputRules() {
            return [Le({ find: K0, type: this.type })]
        },
        addPasteRules() {
            return [ve({ find: q0, type: this.type })]
        },
    }),
    Iu = J0
var fl = 4,
        ...
        addKeyboardShortcuts() {
            return {
                ...
                Tab: ({ editor: t }) => {
                    ...
                    let n = (e = this.options.tabSize) != null ? e : fl,
                        { state: r } = t,
                        { selection: o } = r,
                        { $from: i, empty: s } = o
                ...
                ArrowDown: ({ editor: t }) => {
                    ...
                    return l === void 0
                        ...
                        : r.nodeAt(l)
                          ? t.commands.command(
                                ({ tr: c }) => (
                                    c.setSelection(P.near(r.resolve(l))), !0
                                ),
                            )
                          : t.commands.exitCode()
                },
...
var xo = (t, e) => e.view.domAtPos(t).node.offsetParent !== null,
    Q0 = (t, e, n) => {
    ...
    Bu = (t, e) => {
        ...
        if (
            ...
            return !1
        let d = Xe((y) => y.type === i.nodes.details)(s)
        if (!d) return !1
        let u = vn(d.node, (y) => y.type === i.nodes.detailsContent)
    ...
    zu = F.create({
        ...
        addKeyboardShortcuts() {
            return {
                ...
                ArrowRight: ({ editor: t }) => Bu(t, 'right'),
                ArrowDown: ({ editor: t }) => Bu(t, 'down'),
            }
        },
        addProseMirrorPlugins() {
            return [
                new B({
                    key: new $('detailsSelection'),
                    appendTransaction: (t, e, n) => {
            ...
            return {
                Enter: ({ editor: t }) => {
                    ...
                    let b = o.indexAfter(-3),
                        x = tr(y.contentMatchAt(b))
                    if (!x || !y.canReplaceWith(b, b, x)) return !1
                    let v = x.createAndFill()
                    if (!v) return !1
                    let { tr: w } = e,
                        C = o.after(-2)
                    w.replaceWith(C, C, v)
                    let k = w.doc.resolve(C),
                        T = P.near(k, 1)
                    w.setSelection(T)
                    let O = m,
                        A = m + p.nodeSize
                    return w.delete(O, A), w.scrollIntoView(), n.dispatch(w), !0
                },
            }
        },
...
var nb = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/,
    ...
    ob = Z.create({
        ...
        addInputRules() {
            return [Le({ find: nb, type: this.type })]
        },
        addPasteRules() {
            return [ve({ find: rb, type: this.type })]
        },
    }),
    Uu = ob
var ib = F.create({
        ...
        addCommands() {
            return {
                setHorizontalRule:
                    () =>
                    ({ chain: t, state: e }) => {
                        if (!yu(e, e.schema.nodes[this.name])) return !1
                        let { selection: n } = e,
                            { $to: r } = n,
                            o = t()
                        return (
        ...
        addInputRules() {
            return [
                po({ find: /^(?:---|—-|___\s|\*\*\*\s)$/, type: this.type }),
            ]
        },
    }),
    Ku = ib
var sb = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/,
    ...
    db = Z.create({
        ...
        addInputRules() {
            return [
                Le({ find: sb, type: this.type }),
                Le({ find: ab, type: this.type }),
            ]
        },
        addPasteRules() {
            return [
                ve({ find: lb, type: this.type }),
                ve({ find: cb, type: this.type }),
            ]
        },
    }),
    qu = db
...
Me.prototype = {
    ...
    tr(t, e, n, r) {
        ...
        let o
        return (
            e && e.j ? (o = e) : ((o = new Me(e)), n && r && Zt(e, n, r)),
            this.jr.push([t, o]),
            o
        )
    },
        ...
        if (
            ...
            if (r)
                if (s.t && typeof s.t == 'string') {
                    let a = Object.assign(bb(s.t, r), n)
                    Zt(i, a, r)
                } else n && Zt(i, n, r)
            s.t = i
        }
...
var W = (t, e, n, r, o) => t.ta(e, n, r, o),
    ne = (t, e, n, r, o) => t.tr(e, n, r, o),
    Yu = (t, e, n, r, o) => t.ts(e, n, r, o),
    ...
    Eo = 'CLOSEPAREN',
    No = 'OPENANGLEBRACKET',
    Oo = 'CLOSEANGLEBRACKET',
    Ro = 'FULLWIDTHLEFTPAREN',
    Do = 'FULLWIDTHRIGHTPAREN',
    Io = 'LEFTCORNERBRACKET',
    Po = 'RIGHTCORNERBRACKET',
    Lo = 'LEFTWHITECORNERBRACKET',
    Bo = 'RIGHTWHITECORNERBRACKET',
    zo = 'FULLWIDTHLESSTHAN',
    Ho = 'FULLWIDTHGREATERTHAN',
    $o = 'AMPERSAND',
    Fo = 'APOSTROPHE',
    Vo = 'ASTERISK',
    Rt = 'AT',
...
function kb(t = []) {
    ...
    ko == null && (ko = Zu(hb)),
        ...
        M(n, '\\', _o),
        M(n, '\u30FB', lf)
    let r = ne(n, yt, Al, { [wl]: !0 })
    ne(r, yt, r)
    let o = ne(r, gt, of, { [lr]: !0 }),
        i = ne(r, ir, sf, { [sr]: !0 }),
        s = ne(n, gt, bt, { [xl]: !0 })
    ne(s, yt, o), ne(s, gt, s), ne(o, yt, o), ne(o, gt, o)
    let l = ne(n, ir, Cl, { [kl]: !0 })
    ne(l, gt), ne(l, yt, i), ne(l, ir, l), ne(i, yt, i), ne(i, gt), ne(i, ir, i)
    let a = M(n, gl, El, { [hl]: !0 }),
        c = M(n, Qu, Tl, { [hl]: !0 }),
        d = ne(n, ml, Tl, { [hl]: !0 })
    M(n, yl, d),
        M(c, gl, a),
        ...
        ne(d, ml, d),
        M(d, yl, d)
    let u = ne(n, pl, af, { [rf]: !0 })
    M(u, '#'), ne(u, pl, u), M(u, wb, u)
    let f = M(u, xb)
    M(f, '#'), ne(f, pl, u)
    let h = [
            [gt, s],
    ...
    return (
        Yu(n, 'localhost', hr, { ascii: !0 }),
        (n.jd = new Me(Yo)),
        { start: n, tokens: Object.assign({ groups: e }, cf) }
    )
}
function df(t, e) {
    let n = Sb(e.replace(/[A-Z]/g, (l) => l.toLowerCase())),
        r = n.length,
        o = [],
        i = 0,
        s = 0
...
function vb({ groups: t }) {
    ...
    W(o, t.domain, s),
        ...
        W(s, t.domain, s)
    let c = M(s, Rt)
    M(i, Rt, c), M(l, Rt, c), M(a, Rt, c)
    let d = M(i, et)
    W(d, r, i), W(d, t.domain, i)
    let u = Be()
    W(c, t.domain, u), W(u, t.domain, u)
    let f = M(u, et)
    W(f, t.domain, u)
    let h = Be(tf)
    W(f, t.tld, h), W(f, t.utld, h), M(c, hr, h)
    let p = M(u, ze)
    M(p, ze, p), W(p, t.domain, u), W(h, t.domain, u), M(h, et, f), M(h, ze, p)
    let m = M(h, Dt)
    W(m, t.numeric, tf)
    let g = M(s, ze),
        y = M(s, et)
    M(g, ze, g), W(g, t.domain, s), W(y, r, i), W(y, t.domain, s)
    let b = Be(Co)
    W(y, t.tld, b),
        W(y, t.utld, b),
        W(b, t.domain, s),
    ...
    let w = Be(Co),
        C = Be()
    W(w, e, w), W(w, n, C), W(C, e, w), W(C, n, C), M(b, tt, w), M(v, tt, w)
    let k = M(l, Dt),
        T = M(a, Dt),
        O = M(T, tt),
        A = M(O, tt)
    ...
    return M(o, hr, b), M(o, El, Cb), { start: o, tokens: cf }
}
function Mb(t, e, n) {
    let r = n.length,
        o = 0,
    ...
    for (; o < r; ) {
        ...
        if (f < 0) (o -= d), o < r && (s.push(n[o]), o++)
            ...
            s.length > 0 && (i.push(bl(nf, e, s)), (s = [])), (o -= f), (d -= f)
            let h = u.t,
                p = n.slice(o - d, o)
            i.push(bl(h, e, p))
        }
    }
    return s.length > 0 && i.push(bl(nf, e, s)), i
}
function bl(t, e, n) {
    let r = n[0].s,
        o = n[n.length - 1].e,
...
var Tb = (typeof console < 'u' && console && console.warn) || (() => {}),
    Ab =
...
function Pl(t, e = !1) {
    if (
        (Q.initialized &&
            Tb(
                `linkifyjs: already initialized - will not register custom scheme "${t}" ${Ab}`,
            ),
        ...
        appendTransaction: (e, n, r) => {
            ...
            if (
                (Zs(l).forEach(({ newRange: c }) => {
                    let d = Wd(r.doc, c, (h) => h.isTextblock),
                        u,
                        f
                    if (d.length > 1)
                        (u = d[0]),
                    ...
                    if (u && f) {
                        let h = f.split(Nb).filter(Boolean)
                        if (h.length <= 0) return !1
                        let p = h[h.length - 1],
                            m = u.pos + f.lastIndexOf(p)
                        if (!p) return !1
                        let g = Zo(p).map((y) => y.toObject(t.defaultProtocol))
                        if (!Db(g)) return !1
                        g.filter((y) => y.isLink)
                            .map((y) => ({
                                ...y,
    ...
    return new B({
        ...
        props: {
            handlePaste: (e, n, r) => {
                ...
                let c = ei(a, { defaultProtocol: t.defaultProtocol }).find(
...
var zb = Object.defineProperty,
    Hb = (t, e) => {
        for (var n in e) zb(t, n, { get: e[n], enumerable: !0 })
    },
    $b = 'listItem',
    pf = 'textStyle',
    mf = /^\s*([-+*])\s$/,
...
`,
        ...
        addInputRules() {
            let t = Ye({ find: mf, type: this.type })
            return (
                (this.options.keepMarks || this.options.keepAttributes) &&
                    (t = Ye({
                        ...
                        getAttributes: () => this.editor.getAttributes(pf),
                        editor: this.editor,
                    })),
                [t]
            )
...
var mr = (t, e) => {
    ...
    Bl = (t, e, n) => {
        ...
        if (!Ge(t.state, e) && wf(t.state, e, n)) {
        ...
        if (!Ge(t.state, e) || !Yd(t.state)) return !1
        let r = mr(e, t.state)
        if (!r) return !1
        let i = t.state.doc.resolve(r.$pos.pos - 2).node(r.depth),
            s = kf(e, t.state, i)
        return xf(e, t.state) && !s
    ...
    zl = (t, e) => {
        if (!Ge(t.state, e) || !Xd(t.state, e)) return !1
...
`),
                ...
                c = []
            a &&
                c.push({ type: 'paragraph', raw: a, tokens: n.inlineTokens(a) })
            let d = l
                .slice(1)
                .join(
                    `
        ...
        addExtensions() {
            ...
            return (
                ...
                this.options.listKeymap !== !1 &&
                    t.push(_b.configure(this.options.listKeymap)),
                this.options.orderedList !== !1 &&
                    t.push(Vl.configure(this.options.orderedList)),
                this.options.taskItem !== !1 &&
                    t.push(Jb.configure(this.options.taskItem)),
                this.options.taskList !== !1 &&
                    t.push(Gb.configure(this.options.taskList)),
                t
            )
        },
    })
var ti = (t, e, n = {}) => {
    ...
    Tf = j.create({
        ...
        addProseMirrorPlugins() {
            return [Xb({ editor: this.editor, ...this.options })]
        },
    })
function Yb(t) {
    var e
...
function Zb({
    ...
    let g,
        y = h?.(),
        b = () => {
            let C = e.state.selection.$anchor.pos,
                k = e.view.coordsAtPos(C),
                { top: T, right: O, bottom: A, left: z } = k
            try {
                return new DOMRect(z, T, O - z, A - T)
            } catch {
                return null
            }
        },
        x = (C, k) =>
            k
                ? () => {
                      let T = t.getState(e.state),
                          O = T?.decorationId,
                          A = C.dom.querySelector(`[data-decoration-id="${O}"]`)
    ...
    function v(C, k) {
        ...
        try {
            ...
            ;(T = y?.onExit) == null || T.call(y, V)
        } catch {}
        let O = C.state.tr.setMeta(k, { exit: !0 })
        C.dispatch(O)
    }
    let w = new B({
        key: t,
        view() {
            return {
                update: async (C, k) => {
                    var T, O, A, z, V, U, _
                    let D = (T = this.key) == null ? void 0 : T.getState(k),
                        K =
                            (O = this.key) == null
                                ? void 0
                                : O.getState(C.state),
                        I =
                            D.active &&
                            K.active &&
                            D.range.from !== K.range.from,
                        Y = !D.active && K.active,
                        oe = D.active && !K.active,
                        Pt = !Y && !oe && D.query !== K.query,
                        Rn = Y || (I && Pt),
                        Sr = Pt || I,
                        Si = oe || (I && Pt)
                    if (!Rn && !Sr && !Si) return
                    let sn = Si && !Rn ? D : K,
                        la = C.dom.querySelector(
                    ...
                    ;(g = {
                        ...
                        items: [],
                        command: (np) =>
                            u({ editor: e, range: sn.range, props: np }),
                        decorationNode: la,
                        clientRect: x(C, la),
                    }),
                        Rn && ((A = y?.onBeforeStart) == null || A.call(y, g)),
                        Sr && ((z = y?.onBeforeUpdate) == null || z.call(y, g)),
                        (Sr || Rn) &&
                            (g.items = await f({ editor: e, query: sn.query })),
                        Si && ((V = y?.onExit) == null || V.call(y, g)),
                        Sr && ((U = y?.onUpdate) == null || U.call(y, g)),
                        Rn && ((_ = y?.onStart) == null || _.call(y, g))
                },
                destroy: () => {
                    var C
                    g && ((C = y?.onExit) == null || C.call(y, g))
                },
            }
        },
        state: {
            ...
            apply(C, k, T, O) {
                ...
                if (((D.composing = z), A && (U || e.view.composing))) {
                    ...
                    let I = m({
                        ...
                        Y = `id_${Math.floor(Math.random() * 4294967295)}`
                    I &&
                    p({
                        editor: e,
                        state: O,
        ...
        props: {
            handleKeyDown(C, k) {
                var T, O, A, z
                let { active: V, range: U } = w.getState(C.state)
                if (!V) return !1
                if (k.key === 'Escape' || k.key === 'Esc') {
                    let D = w.getState(C.state),
                        K = (T = g?.decorationNode) != null ? T : null,
                        I =
                            K ??
                            (D?.decorationId
                                ? C.dom.querySelector(
                    ...
                    let oe = {
                        ...
                        items: [],
                        command: (Pt) =>
                            u({ editor: e, range: D.range, props: Pt }),
                        decorationNode: I,
                        clientRect: I
                            ? () => I.getBoundingClientRect() || null
                            : null,
                    }
                    return (A = y?.onExit) == null || A.call(y, oe), v(C, t), !0
                }
                return (
                    ((z = y?.onKeyDown) == null
                        ? void 0
                        : z.call(y, { view: C, event: k, range: U })) || !1
                )
            },
            decorations(C) {
                let {
...
var nw = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/,
    ...
    ow = Z.create({
        ...
        addInputRules() {
            return [Le({ find: nw, type: this.type })]
        },
        addPasteRules() {
            return [ve({ find: rw, type: this.type })]
        },
    }),
    Df = ow
var iw = Z.create({
...
if (typeof WeakMap < 'u') {
    let t = new WeakMap()
    ;(jl = (e) => t.get(e)), (Ul = (e, n) => (t.set(e, n), n))
} else {
    let t = [],
        n = 0
    ;(jl = (r) => {
...
function pw(t, e, n) {
    let r = we(e.type.schema).header_cell
    for (let o = 0; o < t.height; o++)
        if (e.nodeAt(t.map[n + o * t.width]).type != r) return !1
    return !0
}
var G = class wt extends P {
    constructor(e, n = e) {
        let r = e.node(-1),
            o = re.get(r),
            i = e.start(-1),
    ...
    replace(e, n = E.empty) {
        ...
        let i = P.findFrom(e.doc.resolve(e.mapping.slice(r).map(this.to)), -1)
        i && e.setSelection(i)
    }
    replaceWith(e, n) {
        this.replace(e, new E(S.from(n), 0, 0))
    }
    forEachCell(e) {
    ...
    getBookmark() {
        return new mw(this.$anchorCell.pos, this.$headCell.pos)
    }
}
...
var mw = class Kf {
    ...
    map(e) {
        return new Kf(e.map(this.anchor), e.map(this.head))
    }
    resolve(e) {
        let n = e.resolve(this.anchor),
...
function gw(t) {
    ...
    return (
        t.selection.forEachCell((n, r) => {
            e.push(ee.node(r, r + n.nodeSize, { class: 'selectedCell' }))
        }),
        X.create(t.doc, e)
    )
}
function yw({ $from: t, $to: e }) {
...
function Xl(t, e) {
    let n,
        r = (o, i) => {
            o.type.spec.tableRole == 'table' && (n = kw(t, o, i, n))
        }
    return (
        e ? e.doc != t.doc && qf(e.doc, t.doc, 0, r) : t.doc.descendants(r), n
    )
}
function kw(t, e, n, r) {
    let o = re.get(e)
    ...
    for (let a = 0, c = n + 1; a < o.height; a++) {
        ...
        if (f > 0) {
            ...
            let p = []
            for (let g = 0; g < f; g++) {
                let y = we(t.schema)[h].createAndFill()
                y && p.push(y)
            }
    ...
    return r.setMeta(xw, { fixTables: !0 })
}
function nt(t) {
    let e = t.selection,
        n = li(t),
...
function Jf(t, { map: e, tableStart: n, table: r }, o) {
    let i = o > 0 ? -1 : 0
    pw(e, r, o + i) && (i = o == 0 || o == e.width ? null : 0)
    for (let s = 0; s < e.height; s++) {
        ...
        if (o > 0 && o < e.width && e.map[l - 1] == e.map[l]) {
            ...
            t.setNodeMarkup(
                t.mapping.map(n + a),
                null,
                Uf(c.attrs, o - e.colCount(a)),
            ),
                (s += c.attrs.rowspan - 1)
        } else {
            let a =
                    i == null
                        ? we(r.type.schema).cell
...
function Sw(t, { map: e, table: n, tableStart: r }, o) {
...
function Yf(t, e) {
    ...
    if (e) {
        ...
        for (let o = n.right - 1; Sw(r, n, o), o != n.left; o--) {
...
function Cw(t, e, n) {
    var r
    let o = we(e.type.schema).header_cell
...
function Qf(t, { map: e, tableStart: n, table: r }, o) {
    ...
    let s = [],
        l = o > 0 ? -1 : 0
    Cw(e, r, o + l) && (l = o == 0 || o == e.height ? null : 0)
    ...
    return t.insert(i, we(r.type.schema).row.create(null, s)), t
}
function Zf(t, e) {
    if (!_e(t)) return !1
    if (e) {
...
function Ql(t, e) {
    let n = we(t.schema)
    return Tw(({ node: r }) => n[r.type.spec.tableRole])(t, e)
}
function Tw(t) {
    return (e, n) => {
        let r = e.selection,
...
var Fv = En('row', { useDeprecatedLogic: !0 }),
    Vv = En('column', { useDeprecatedLogic: !0 }),
    rh = En('cell', { useDeprecatedLogic: !0 })
function Ew(t, e) {
    if (e < 0) {
        let n = t.nodeBefore
...
function Zl(t) {
    return function (e, n) {
        ...
        if (n) {
            ...
            n(e.tr.setSelection(R.between(o, hw(o))).scrollIntoView())
        }
        return !0
    }
}
...
function ni(t, e) {
    ...
    if (e) {
        let r = t.tr,
            o = we(t.schema).cell.createAndFill().content
        n.forEachCell((i, s) => {
            i.content.eq(o) ||
                r.replace(
                    r.mapping.map(s + 1),
...
function Nw(t) {
    ...
    if (i == 'row')
        for (let a = 0; a < e.childCount; a++) {
            ...
            ;(d || u) && (c = ql(we(s).row, new E(c, d, u)).content), l.push(c)
        }
    else if (i == 'cell' || i == 'header_cell')
        l.push(n || r ? ql(we(s).row, new E(e, n, r)).content : e)
    else return null
    return Ow(s, l)
}
function Ow(t, e) {
...
function Rw({ width: t, height: e, rows: n }, r, o) {
    if (t != r) {
        let i = [],
            s = []
...
function Dw(t, e, n, r, o, i, s) {
    ...
    if (i > e.height) {
        ...
        for (
            ...
            let g =
                p >= e.width ? !1 : n.nodeAt(e.map[m + p]).type == a.header_cell
            u.push(
                g
        ...
        let f = a.row.create(null, S.from(u)),
            h = []
...
function $f(t, e, n, r, o) {
    ...
    Dw(u, s, i, n, c, d, f) && h(),
        zf(u, s, i, n, a, c, l, f) && h(),
        zf(u, s, i, n, a, c, d, f) && h(),
        Hf(u, s, i, n, l, d, a, f) && h(),
        Hf(u, s, i, n, l, d, c, f) && h()
    for (let p = l; p < d; p++) {
...
function ri(t, e) {
    return (n, r, o) => {
        if (!o) return !1
        let i = n.selection
        if (i instanceof G) return ii(n, r, P.near(i.$headCell, e))
        if (t != 'horiz' && !i.empty) return !1
        let s = ih(o, t, e)
        if (s == null) return !1
        if (t == 'horiz') return ii(n, r, P.near(n.doc.resolve(i.head + e), e))
        {
            ...
            return (
                a
                    ? (c = P.near(a, 1))
                    : e < 0
                      ? (c = P.near(n.doc.resolve(l.before(-1)), -1))
                      : (c = P.near(n.doc.resolve(l.after(-1)), 1)),
                ii(n, r, c)
            )
        }
    }
    ...
    if (o instanceof G) {
        r ||
            (r = {
                width: 1,
                height: 1,
                rows: [S.from(ql(we(t.state.schema).cell, n))],
            })
        ...
        return (
            (r = Rw(r, l.right - l.left, l.bottom - l.top)),
            $f(t.state, t.dispatch, s, l, r),
            !0
        )
    } else if (r) {
        let i = li(t.state),
...
function Bw(t, e) {
    ...
    if (e.shiftKey && t.state.selection instanceof G)
        ...
        ((n = Wl(t, e)) === null || n === void 0 ? void 0 : n.pos) != o.pos
    )
        i(o, e), e.preventDefault()
    else if (!r) return
    function i(a, c) {
        let d = Wl(t, c),
            u = It.getState(t.state) == null
        if (!d || !Gl(a, d))
            if (u) d = a
            else return
        let f = new G(a, d)
    ...
    function l(a) {
        let c = a,
            d = It.getState(t.state),
            u
        if (d != null) u = t.state.doc.resolve(d)
        else if (Ff(t, c.target) != r && ((u = Wl(t, e)), !u)) return s()
        u && i(u, c)
    }
...
function Wl(t, e) {
    ...
    if (!n) return null
    let r = n.inside >= 0 ? n.inside : n.pos
    return An(t.state.doc.resolve(r))
}
var zw = class {
    constructor(t, e) {
        ;(this.node = t),
...
var Ee = new $('tableColumnResizing')
function sh({
    handleWidth: t = 5,
    cellMinWidth: e = 25,
    ...
    let i = new B({
            ...
            init(s, l) {
                ...
                let c =
                        ...
                        a === void 0
                            ? void 0
                            : a.nodeViews,
                    d = we(l.schema).table.name
                return (
                    r && c && (c[d] = (u, f) => new r(u, n, f)), new Hw(-1, !1)
                )
            },
            apply(s, l) {
                return l.apply(s)
        ...
        props: {
            ...
            decorations: (s) => {
                let l = Ee.getState(s)
                if (l && l.activeHandle > -1) return Kw(s, l.activeHandle)
            },
            nodeViews: {},
        },
    })
...
var Hw = class si {
    ...
    apply(e) {
        ...
        if (n.activeHandle > -1 && e.docChanged) {
            ...
            return Kl(e.doc.resolve(o)) || (o = -1), new si(o, n.dragging)
        }
        return n
    }
}
function $w(t, e, n, r) {
    ...
    if (o && !o.dragging) {
        ...
        if (i) {
            ...
            e.clientX - l <= n
                ? (s = Vf(t, e, 'left', n))
                : a - e.clientX <= n && (s = Vf(t, e, 'right', n))
        }
        if (s != o.activeHandle) {
            if (!r && s !== -1) {
...
function Fw(t) {
    ...
    e && e.activeHandle > -1 && !e.dragging && lh(t, -1)
}
function Vw(t, e, n, r) {
    var o
    ...
    function c(u) {
        ...
        f?.dragging &&
            (jw(t, f.activeHandle, _f(f.dragging, u, n)),
    ...
    function d(u) {
        ...
        let f = Ee.getState(t.state)
        if (f && f.dragging) {
            let h = _f(f.dragging, u, n)
            Wf(t, f.activeHandle, h, r)
        }
    }
    return (
        Wf(t, s.activeHandle, a, r),
...
function _w(t, e, { colspan: n, colwidth: r }) {
...
function jw(t, e, n) {
    ...
    for (let c = 0; c < i.height; c++) {
        ...
        let p = f.colwidth ? f.colwidth.slice() : Uw(f.colspan)
    ...
    for (let c = 0; c < i.height; c++) {
        ...
        if (
            ...
            ;(h.className = 'column-resize-handle'),
                !((a = Ee.getState(t)) === null || a === void 0) &&
                    a.dragging &&
                    n.push(
                        ee.node(s + u, s + u + o.nodeAt(u).nodeSize, {
                            class: 'column-resize-dragging',
                        }),
                    ),
                n.push(ee.widget(f, h))
        }
    }
    return X.create(t.doc, n)
}
function ah({ allowTableNodeSelection: t = !1 } = {}) {
    return new B({
        key: It,
        state: {
            init() {
        ...
        props: {
            decorations: gw,
            handleDOMEvents: { mousedown: Bw },
            createSelectionBetween(e) {
                return It.getState(e.state) != null ? e.state.selection : null
            },
            handleTripleClick: Pw,
            handleKeyDown: Iw,
            handlePaste: Lw,
        },
        appendTransaction(e, n, r) {
            return ww(r, Xl(r, n), t)
        },
    })
}
var qw = F.create({
        ...
        for (let f = 0, h = 0; f < d.childCount; f += 1) {
            ...
            for (let g = 0; g < p; g += 1, h += 1) {
                ...
                if (((l += y || r), y || (a = !1), c)) {
                    ...
                    let x = document.createElement('col'),
                        [v, w] = ea(r, y)
                    x.style.setProperty(v, w), e.appendChild(x)
                }
            }
        }
    for (; c; ) {
...
var Xw = class {
    constructor(t, e) {
        ;(this.node = t),
            ...
            ch(t, this.colgroup, this.table, e),
            (this.contentDOM = this.table.appendChild(
                document.createElement('tbody'),
            ))
    }
    update(t) {
        return t.type !== this.node.type
            ? !1
            : ((this.node = t),
              ch(t, this.colgroup, this.table, this.cellMinWidth),
              !0)
    }
    ignoreMutation(t) {
        let e = t.target,
...
var ai = ({ editor: t }) => {
        ...
        if (!ex(e)) return !1
        let n = 0,
            r = Js(e.ranges[0].$from, (i) => i.type.name === 'table')
        return (
...
function rx(t, e, n = {}) {
    var r
    let o = (r = n.cellLineSeparator) != null ? r : tx
        ...
        p.content &&
            p.content.forEach((g) => {
                ...
                g.content && Array.isArray(g.content) && g.content.length > 1
                    ? (y = g.content.map((w) => e.renderChildren(w)).join(o))
                    : (y = g.content ? e.renderChildren(g.content) : '')
                let b = nx(y),
                    x = g.type === 'tableHeader'
                m.push({ text: b, isHeader: x })
            }),
            i.push(m)
    })
    ...
    i.forEach((p) => {
        var m
        for (let g = 0; g < s; g += 1) {
            let b = (((m = p[g]) == null ? void 0 : m.text) || '').length
    ...
    ix = F.create({
        ...
        renderHTML({ node: t, HTMLAttributes: e }) {
            let {
                    ...
                    tableWidth: r,
                    tableMinWidth: o,
                } = Yw(t, this.options.cellMinWidth),
                i = e.style
            function s() {
        ...
        addCommands() {
            return {
                ...
                setCellSelection:
                    ...
                    ({ tr: e, dispatch: n }) => {
                        if (n) {
                            let r = G.create(e.doc, t.anchorCell, t.headCell)
                            e.setSelection(r)
                        }
                        return !0
                    },
        ...
        extendNodeSchema(t) {
            ...
            return { tableRole: J(H(t, 'tableRole', e)) }
        },
    }),
    uh = j.create({
        name: 'tableKit',
        addExtensions() {
            ...
            return (
                this.options.table !== !1 &&
                    t.push(ix.configure(this.options.table)),
                this.options.tableCell !== !1 &&
                    t.push(qw.configure(this.options.tableCell)),
                this.options.tableHeader !== !1 &&
                    t.push(Jw.configure(this.options.tableHeader)),
                this.options.tableRow !== !1 &&
                    t.push(Gw.configure(this.options.tableRow)),
                t
            )
        },
    })
...
var ax = Z.create({
    ...
    ph = ax
var ta = ['top', 'right', 'bottom', 'left'],
    mh = ['start', 'end'],
    na = ta.reduce((t, e) => t.concat(e, e + '-' + mh[0], e + '-' + mh[1]), []),
    He = Math.min,
    pe = Math.max,
    br = Math.round
var We = (t) => ({ x: t, y: t }),
...
var ux = new Set(['top', 'bottom'])
function je(t) {
    return ux.has(Ne(t)) ? 'y' : 'x'
}
function ui(t) {
    return ra(je(t))
}
...
function gr(t) {
    return t.replace(/start|end/g, (e) => dx[e])
}
var gh = ['left', 'right'],
    yh = ['right', 'left'],
    fx = ['top', 'bottom'],
...
function yr(t) {
    return t.replace(/left|right|bottom|top/g, (e) => cx[e])
}
function mx(t) {
...
var vh = (t) => ({
    ...
    async fn(e) {
        ...
        let u = fi(d),
            ...
            v = i.reference[p] + i.reference[h] - f[h] - i.floating[p],
            w = f[h] - i.reference[h],
        ...
        let T = v / 2 - w / 2,
            ...
            K =
                ...
                $e(o) != null &&
                _ !== D &&
                i.reference[p] / 2 - (_ < V ? A : z) - m[p] / 2 < 0,
            I = K ? (_ < V ? _ - V : _ - U) : 0
        return {
            [h]: f[h] + I,
            data: {
            ...
            t === void 0 && (t = {}),
            {
                ...
                async fn(e) {
                    ...
                    let {
                        ...
                        m = u !== void 0 || f === na ? gx(u || null, h, f) : f,
                        g = await nn(e, p),
                        y =
            ...
            t === void 0 && (t = {}),
            {
                ...
                async fn(e) {
                    ...
                    let y = Ne(o),
                        b = je(l),
                        x = Ne(l) === l,
                        v = await (a.isRTL == null
                            ? void 0
                            : a.isRTL(c.floating)),
                        w = f || (x || !m ? [yr(l)] : bh(l)),
                        C = p !== 'none'
                    !f && C && w.push(...wh(l, m, p, v))
                    let k = [l, ...w],
                        T = await nn(e, g),
                        O = [],
                    ...
                    if (
                        ...
                        let K =
                            (V = A.filter((I) => I.overflows[0] <= 0).sort(
                                (I, Y) => I.overflows[1] - Y.overflows[1],
                            )[0]) == null
                                ? void 0
                                : V.placement
                        if (!K)
                    ...
                    case 'referenceHidden': {
                        ...
                        return {
                            data: {
                                ...
                                referenceHidden: Sh(s),
                            },
                        }
                    }
                    case 'escaped': {
                        let i = await nn(e, { ...o, altBoundary: !0 }),
                            s = kh(i, n.floating)
                        return { data: { escapedOffsets: s, escaped: Sh(s) } }
                    }
                    default:
                        return {}
                }
                    ...
                    function p() {
                        ...
                        if (u.length >= 2) {
                            ...
                            let g = Ne(n) === 'left',
                                ...
                                b = He(...u.map((A) => A.left)),
                                x = u.filter((A) =>
                                    g ? A.left === b : A.right === y,
                                ),
                                v = x[0].top,
                                w = x[x.length - 1].bottom,
                                C = b,
                                k = y,
                                T = k - C,
                                O = w - v
    ...
    return (
        t === void 0 && (t = {}),
        {
            ...
            async fn(e) {
                ...
                await a({ ...e, availableWidth: T, availableHeight: k })
                let O = await s.getDimensions(l.floating)
...
function rn(t) {
    return Ph(t) ? (t.nodeName || '').toLowerCase() : '#document'
}
function Te(t) {
    var e
    return (
...
function ot(t) {
    var e
    return (e = (Ph(t) ? t.ownerDocument : t.document) || window.document) ==
        null
        ? void 0
        : e.documentElement
}
function Ph(t) {
    return pi() ? t instanceof Node || t instanceof Te(t).Node : !1
}
function Fe(t) {
    return pi() ? t instanceof Element || t instanceof Te(t).Element : !1
}
function Ue(t) {
    return pi()
        ? t instanceof HTMLElement || t instanceof Te(t).HTMLElement
        : !1
}
function Ih(t) {
    return !pi() || typeof ShadowRoot > 'u'
        ? !1
        : t instanceof ShadowRoot || t instanceof Te(t).ShadowRoot
}
var xx = new Set(['inline', 'contents'])
function Nn(t) {
    let { overflow: e, overflowX: n, overflowY: r, display: o } = Ve(t)
    return /auto|scroll|overlay|hidden|clip/.test(e + r + n) && !xx.has(o)
}
var kx = new Set(['table', 'td', 'th'])
function Lh(t) {
    return kx.has(rn(t))
}
var Sx = [':popover-open', ':modal']
function wr(t) {
    return Sx.some((e) => {
        try {
            return t.matches(e)
...
var Cx = ['transform', 'translate', 'scale', 'rotate', 'perspective'],
...
var Tx = new Set(['html', 'body', '#document'])
function on(t) {
    return Tx.has(rn(t))
}
function Ve(t) {
...
function kt(t) {
    ...
    let e = t.assignedSlot || t.parentNode || (Ih(t) && t.host) || ot(t)
...
function On(t) {
    ...
    let n = e.getBoundingClientRect(),
        { width: r, height: o, $: i } = Vh(e),
        s = (i ? br(n.width) : n.width) / r,
        l = (i ? br(n.height) : n.height) / o
    return (
...
function Ex(t, e, n) {
    return e === void 0 && (e = !1), !n || (e && n !== Te(t)) ? !1 : e
}
function kr(t, e, n, r) {
    ...
    let o = t.getBoundingClientRect(),
        i = _h(t),
        s = We(1)
    e && (r ? Fe(r) && (s = On(r)) : (s = On(t)))
    let l = Ex(i, n, r) ? Wh(i) : We(0),
        a = (o.left + l.x) / s.x,
        c = (o.top + l.y) / s.y,
        d = o.width / s.x,
        u = o.height / s.y
    if (i) {
        ...
        for (; m && r && h !== p; ) {
            let g = On(m),
                ...
                v = y.top + (m.clientTop + parseFloat(b.paddingTop)) * g.y
            ;(a *= g.x),
                (c *= g.y),
                (d *= g.x),
                (u *= g.y),
...
function bi(t, e) {
    let n = xr(t).scrollLeft
    return e ? e.left + n : kr(ot(t)).left + n
}
function jh(t, e) {
    let n = t.getBoundingClientRect(),
        r = n.left + e.scrollLeft - bi(t, n),
        o = n.top + e.scrollTop
    return { x: r, y: o }
}
function Nx(t) {
    ...
    if (
        (u || (!u && !i)) &&
        ((rn(r) !== 'body' || Nn(s)) && (a = xr(r)), Ue(r))
    ) {
        let h = kr(r)
        ;(c = On(r)), (d.x = h.x + r.clientLeft), (d.y = h.y + r.clientTop)
    }
    let f = s && !u && !i ? jh(s, a) : We(0)
    return {
        width: n.width * c.x,
        height: n.height * c.y,
...
function $h(t, e, n) {
    let r
    if (e === 'viewport') r = Dx(t, n)
    else if (e === 'document') r = Rx(ot(t))
    else if (Fe(e)) r = Px(e, n)
    else {
        let o = Wh(t)
...
function Hx(t, e, n) {
    ...
    if (r || (!r && !i))
        if (((rn(e) !== 'body' || Nn(o)) && (l = xr(e)), r)) {
            let h = kr(e, !0, i, e)
            ;(a.x = h.x + e.clientLeft), (a.y = h.y + e.clientTop)
        } else o && c()
    i && !r && o && c()
    let d = o && !r && !i ? jh(o, l) : We(0),
...
function Fh(t, e) {
    if (!Ue(t) || Ve(t).position === 'fixed') return null
    if (e) return e(t)
...
function Kh(t, e) {
    ...
    let r = Fh(t, e)
    for (; r && Lh(r) && ia(r); ) r = Fh(r, e)
    return r && on(r) && ia(r) && !mi(r) ? n : r || Bh(t) || n
}
var $x = async function (t) {
    let e = this.getOffsetParent || Kh,
        n = this.getDimensions,
        r = await n(t.floating)
    return {
        reference: Hx(t.reference, await e(t.floating), t.strategy),
...
var Zh = (t, e) => {
    ...
    ep = ({ mergeTags: t, noMergeTagSearchResultsMessage: e }) => ({
        items: ({ query: n }) =>
            Object.entries(t)
                .filter(
                    ([r, o]) =>
        ...
        render: () => {
            let n,
                ...
                i = () => {
                    ...
                    return (
                        (f.className = 'fi-dropdown-panel fi-dropdown-list'), f
                    )
                },
                s = () => {
                    if (!n || !o) return
            ...
            return {
                onStart: (f) => {
                    ;(o = f),
                        ...
                        f.clientRect && Zh(f.editor, n)
                },
                onUpdate: (f) => {
                    ;(o = f), (r = 0), s(), a(), f.clientRect && Zh(f.editor, n)
                },
                onKeyDown: (f) =>
                    f.event.key === 'Escape'
...
var tp = async ({
    ...
    key: c,
    maxFileSize: d,
    maxFileSizeValidationMessage: u,
    mergeTags: f,
    noMergeTagSearchResultsMessage: h,
    placeholder: p,
    statePath: m,
    textColors: g,
    uploadingFileMessage: y,
    $wire: b,
}) => {
    let x = [
            Ru,
            ...
            Ku,
            qu,
            Gu.configure({ inline: !0 }),
            Xu,
            hf.configure({ autolink: !0, openOnClick: !1, protocols: a }),
            $l,
            ...(n
                ? [
                      Tf.configure({
            ...
            Vl,
            Nf,
            _l.configure({ placeholder: p }),
            Rf.configure({ textColors: g }),
            Of,
            Df,
            If,
            Pf,
            uh.configure({ table: { resizable: !0 } }),
            fh,
            hh.configure({
        ...
        v = await Promise.all(
            r.map(async (w) => {
                new RegExp('^(?:[a-z+]+:)?//', 'i').test(w) ||
                    (w = new URL(w, document.baseURI).href)
                try {
                    let k = (await import(w)).default
                    return typeof k == 'function' ? k() : k
                } catch (k) {
                    return (
                        console.error(
                            `Failed to load rich editor custom extension from [${w}]:`,
                            k,
                        ),
                        null
                    )
    ...
    for (let w of v) {
        ...
        let C = x.findIndex((k) => k.name === w.name)
        w.name === 'placeholder' &&
            w.parent === null &&
            (w = _l.configure(w.options)),
            C !== -1 ? (x[C] = w) : x.push(w)
    }
    return x
}
            ...
            ;(this.preventHide = !1),
                ...
                (this.shouldShow = ({ view: d, state: u, from: f, to: h }) => {
                    let { doc: p, selection: m } = u,
                        { empty: g } = m,
                        y = !p.textBetween(f, h).length && lo(u.selection),
        ...
        get middlewares() {
            ...
            return (
                ...
                this.floatingUIOptions.arrow &&
                    t.push(Yh(this.floatingUIOptions.arrow)),
            ...
            let { selection: e } = this.editor.state,
                n =
                    (t = this.getReferencedVirtualElement) == null
                        ...
                        : t.call(this)
            if (n) return n
            let r = eu(this.view, e.from, e.to),
                o = {
...
function jx({
    ...
    livewireId: p,
    maxFileSize: m,
    maxFileSizeValidationMessage: g,
    mergeTags: y,
    noMergeTagSearchResultsMessage: b,
    placeholder: x,
    state: v,
    statePath: w,
    textColors: C,
    uploadingFileMessage: k,
}) {
    let T,
        O = [],
        A = !1
    return {
        ...
        async init() {
            T = new mu({
                ...
                extensions: await tp({
                    ...
                    floatingToolbars: l,
                    insertCustomBlockUsing: (I, Y = null) =>
                        this.$wire.mountAction(
                            'customBlock',
                            { id: I, dragPosition: Y, mode: 'insert' },
                            { schemaComponent: u },
                        ),
                    key: u,
                    linkProtocols: f,
            ...
            let z = 'paragraph' in l
            Object.keys(l).forEach((I) => {
                let Y = this.$refs[`floatingToolbar::${I}`]
                if (!Y) {
                    console.warn(`Floating toolbar [${I}] not found.`)
                    return
                }
                T.registerPlugin(
                    sa({
                        editor: T,
                        element: Y,
                        pluginKey: `floatingToolbar::${I}`,
                        shouldShow: ({ editor: oe }) =>
                            I === 'paragraph'
                                ? oe.isFocused &&
                                  oe.isActive(I) &&
                                  !oe.state.selection.empty
                                : z &&
                                    !oe.state.selection.empty &&
                                    oe.isActive('paragraph')
                                  ? !1
                                  : oe.isFocused && oe.isActive(I),
            ...
            let V = Alpine.debounce(() => {
                A || this.$wire.commit()
            }, h ?? 300)
            T.on('update', ({ editor: I }) =>
                this.$nextTick(() => {
                    A ||
                        ((this.editorUpdatedAt = Date.now()),
                        (this.state = I.getJSON()),
                        (this.shouldUpdateState = !1),
                        (this.fileValidationMessage = null),
                        c && V())
                }),
            ),
                T.on('selectionUpdate', ({ transaction: I }) => {
                    A ||
                        ((this.editorUpdatedAt = Date.now()),
                        (this.editorSelection = I.selection.toJSON()))
                }),
                d &&
                    T.on('blur', () => {
                        A || this.$wire.commit()
                ...
                this.$watch('state', () => {
                    if (!A) {
                        ...
                        T.commands.setContent(this.state)
                    }
                })
            let U = (I) => {
                I.detail.livewireId === p &&
                    I.detail.key === u &&
                    this.runEditorCommands(I.detail)
            }
            window.addEventListener('run-rich-editor-commands', U),
                O.push(['run-rich-editor-commands', U])
            let _ = (I) => {
                I.detail.livewireId === p &&
                    I.detail.key === u &&
            ...
            window.addEventListener('rich-editor-uploading-file', _),
                O.push(['rich-editor-uploading-file', _])
            let D = (I) => {
                I.detail.livewireId === p &&
                    I.detail.key === u &&
                    ((this.isUploadingFile = !1), I.stopPropagation())
            }
            window.addEventListener('rich-editor-uploaded-file', D),
                O.push(['rich-editor-uploaded-file', D])
            let K = (I) => {
                I.detail.livewireId === p &&
                    I.detail.key === u &&
                    ((this.isUploadingFile = !1),
                    (this.fileValidationMessage = I.detail.validationMessage),
                    I.stopPropagation())
            }
            window.addEventListener('rich-editor-file-validation-message', K),
                O.push(['rich-editor-file-validation-message', K]),
                window.dispatchEvent(
                    new CustomEvent(`schema-component-${p}-${u}-loaded`),
                )
        },
        getEditor() {
            return T
        ...
        setEditorSelection(z) {
            z &&
                ((this.editorSelection = z),
                T.chain()
                    .command(
                        ({ tr: V }) => (
                            V.setSelection(
                                P.fromJSON(T.state.doc, this.editorSelection),
                            ),
                            !0
                        ),
                    )
        ...
        runEditorCommands({ commands: z, editorSelection: V }) {
            this.setEditorSelection(V)
            let U = T.chain()
            z.forEach((_) => (U = U[_.name](...(_.arguments ?? [])))), U.run()
        },
        togglePanel(z = null) {
            if (this.isPanelActive(z)) {
                this.activePanel = null
                return
            }
            this.activePanel = z
        },
        isPanelActive(z = null) {
            return z === null
                ? this.activePanel !== null
                : this.activePanel === z
        },
